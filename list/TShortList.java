...
import PJC.list.iterator.TShortListIterator;
...
public interface TShortList extends TShortCollection {
     ...
     */
     ...
     /**
      * Appends all of the elements in the specified <tt>TShortCollection</tt> to the
      * end of this list, in the same order. The behavior of this operation is
      * undefined if the specified collection is modified while the operation is
      * in progress.
      * @param c <tt>TShortCollection</tt> containing elements to be added to this list
      */
     public boolean addAll (TShortCollection c);
     
     /**
      * Appends all of the elements in the specified array of shorts to the end of 
      ...
      * @param array array of shorts containing elements to be added to this list
      */
     ...
     /**
      * Inserts all of the elements in the specified <tt>TShortCollection</tt> into this
      * list at the specified position. Shifts the element currently at that position
      * (if any) and any subsequent elements will appear in this list in the same order.
      * The behavior of this operation is undefined if the specified collection is
      * modified while the operation is in progress.
      ...
      * @return true if this list changed as a result of the call
      */
     public boolean addAll (int index, TShortCollection c);
     
     /**
      * Inserts all of the elements in the specified array of shorts into this list at the
     ...
     /**
      * Returns true if this list contains all of the elements of the specified collection.
      * @param c <tt>TShortCollection</tt> to be checked for containment in this list
      * @return true if this list contains all of the elements of the specified collection
      */
     public boolean containsAll (TShortCollection c);
     
     /**
      * Returns true if this list contains all of the elements of the specified array.
      * @param array array of shorts to be checked for containment in this list
      ...
      * only if the specified object is a <tt>List</tt> or a <tt>TShortList</tt>,
     ...
     */
    public TShortListIterator listIterator();
     ...
     */
    public TShortListIterator listIterator (int index);
     ...
     * Removes from this list all of its elements that are contained in the specified
     * collection. This call will order the elements of the specified collection.
     * @param c <tt>TShortCollection</tt> containing elements to be removed from this list
     * @return true if this list changed as a result of the call
     */
    public boolean removeAll (TShortCollection c);
    
    /**
     * Removes from this list all of its elements that are contained in the specified
     * array. This call will order the elements of the specified array.
     * @param array array of shorts containing elements to be removed from this list
     * @return true if this list changed as a result of the call
     */
    ...
    /**
     * Retains only the elements in this list that are contained in the specified
     * <tt>TShortCollection</tt>. In other words, removes from this list all of its elements
     * that are not contained in the specified collection. This call will order the elements
     * of the specified collection.
     * @param c <tt>TShortCollection</tt> containing elements to be retained in this list
     * @return true if this list changed as a result of the call
     */
    public boolean retainAll (TShortCollection c);
    
    /**
     * Retains only the elements in this list that are contained in the specified
     * array of shorts. In other words, removes from this list all of its elements
     * that are not contained in the specified collection. This call will order the elements
     * of the specified array.
     * @param array array of shorts containing elements to be retained in this list
     * @return true if this list changed as a result of the call
     */
