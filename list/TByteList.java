...
public interface TByteList extends TByteCollection {
     ...
     */
     ...
     /**
      * Appends all of the elements in the specified <tt>TByteCollection</tt> to the
      * end of this list, in the same order. The behavior of this operation is
      * undefined if the specified collection is modified while the operation is
      * in progress.
     ...
     /**
      * Appends all of the elements in the specified array of bytes to the end of 
      ...
      * @param array array of bytes containing elements to be added to this list
      */
     ...
     /**
      * Inserts all of the elements in the specified <tt>TByteCollection</tt> into this
      * list at the specified position. Shifts the element currently at that position
      * (if any) and any subsequent elements will appear in this list in the same order.
      * The behavior of this operation is undefined if the specified collection is
      * modified while the operation is in progress.
     ...
     /**
      * Inserts all of the elements in the specified array of bytes into this list at the
     ...
     /**
      * Returns true if this list contains all of the elements of the specified collection.
      * @param c <tt>TByteCollection</tt> to be checked for containment in this list
      * @return true if this list contains all of the elements of the specified collection
      */
     public boolean containsAll (TByteCollection c);
     
     /**
      * Returns true if this list contains all of the elements of the specified array.
      * @param array array of bytes to be checked for containment in this list
      ...
      * only if the specified object is a <tt>List</tt> or a <tt>TByteList</tt>,
     ...
     * @param array array of bytes containing elements to be removed from this list
     * @return true if this list changed as a result of the call
     */
    ...
    /**
     * Retains only the elements in this list that are contained in the specified
     * <tt>TByteCollection</tt>. In other words, removes from this list all of its elements
     * that are not contained in the specified collection. This call will order the elements
     * of the specified collection.
    ...
    /**
     * Retains only the elements in this list that are contained in the specified
     * array of bytes. In other words, removes from this list all of its elements
     * that are not contained in the specified collection. This call will order the elements
     * of the specified array.
     * @param array array of bytes containing elements to be retained in this list
     * @return true if this list changed as a result of the call
     */
