...
public interface TCharDoubleMap {
     ...
     */
    public double compute (char key, BiFunction<? super Character, ? super Double,
     ...
     */
    public double computeIfPresent (char key, BiFunction<? super Character, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Double,
