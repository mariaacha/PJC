...
public interface TIntFloatMap {
     ...
     */
    public float compute (int key, BiFunction<? super Integer, ? super Float,
     ...
     */
    public float computeIfPresent (int key, BiFunction<? super Integer, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Float,
