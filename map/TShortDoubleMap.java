...
public interface TShortDoubleMap {
     ...
     */
    public double compute (short key, BiFunction<? super Short, ? super Double,
     ...
     */
    public double computeIfPresent (short key, BiFunction<? super Short, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Double,
