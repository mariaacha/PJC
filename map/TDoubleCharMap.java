...
public interface TDoubleCharMap {
     ...
     */
    public char compute (double key, BiFunction<? super Double, ? super Character,
     ...
     */
    public char computeIfPresent (double key, BiFunction<? super Double, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Character,
    		? extends Character> function);
