...
public interface TLongDoubleMap {
     ...
     */
    public double compute (long key, BiFunction<? super Long, ? super Double,
     ...
     */
    public double computeIfPresent (long key, BiFunction<? super Long, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Double,
