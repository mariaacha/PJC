...
public interface TCharFloatMap {
     ...
     */
    public float compute (char key, BiFunction<? super Character, ? super Float,
     ...
     */
    public float computeIfPresent (char key, BiFunction<? super Character, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Float,
