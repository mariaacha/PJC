...
public interface TByteCharMap {
     ...
     */
    public char compute (byte key, BiFunction<? super Byte, ? super Character,
     ...
     */
    public char computeIfPresent (byte key, BiFunction<? super Byte, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Byte, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TByteCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Byte, ? super Character,
