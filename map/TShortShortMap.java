...
public interface TShortShortMap {
     ...
     */
    public short compute (short key, BiFunction<? super Short, ? super Short,
     ...
     */
    public short computeIfPresent (short key, BiFunction<? super Short, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortShortMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Short,
