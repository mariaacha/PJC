...
public interface TByteDoubleMap {
     ...
     */
    public double compute (byte key, BiFunction<? super Byte, ? super Double,
     ...
     */
    public double computeIfPresent (byte key, BiFunction<? super Byte, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Byte, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TByteDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Byte, ? super Double,
