...
public interface TFloatLongMap {
     ...
     */
    public long compute (float key, BiFunction<? super Float, ? super Long,
     ...
     */
    public long computeIfPresent (float key, BiFunction<? super Float, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Long,
