...
public interface TShortByteMap {
     ...
     */
    public byte compute (short key, BiFunction<? super Short, ? super Byte,
     ...
     */
    public byte computeIfPresent (short key, BiFunction<? super Short, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Byte,
