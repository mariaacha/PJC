...
public interface TCharCharMap {
     ...
     */
    public char compute (char key, BiFunction<? super Character, ? super Character,
     ...
     */
    public char computeIfPresent (char key, BiFunction<? super Character, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Character,
