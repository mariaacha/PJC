...
public interface TFloatByteMap {
     ...
     */
    public byte compute (float key, BiFunction<? super Float, ? super Byte,
     ...
     */
    public byte computeIfPresent (float key, BiFunction<? super Float, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Byte,
