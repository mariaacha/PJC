...
public interface TCharShortMap {
     ...
     */
    public short compute (char key, BiFunction<? super Character, ? super Short,
     ...
     */
    public short computeIfPresent (char key, BiFunction<? super Character, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharShortMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Short,
