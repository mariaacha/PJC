...
public interface TLongLongMap {
     ...
     */
    public long computeIfPresent (long key, BiFunction<? super Long, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Long,
