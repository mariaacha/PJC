...
public interface TDoubleDoubleMap {
     ...
     */
    public double compute (double key, BiFunction<? super Double, ? super Double,
     ...
     */
    public double computeIfPresent (double key, BiFunction<? super Double, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Double,
