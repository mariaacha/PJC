...
public interface TCharByteMap {
     ...
     */
    public byte compute (char key, BiFunction<? super Character, ? super Byte,
     ...
     */
    public byte computeIfPresent (char key, BiFunction<? super Character, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Byte,
