...
public interface TIntDoubleMap {
     ...
     */
    public double compute (int key, BiFunction<? super Integer, ? super Double,
     ...
     */
    public double computeIfPresent (int key, BiFunction<? super Integer, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Double,
