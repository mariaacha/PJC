...
public interface TByteLongMap {
     ...
     */
    public long compute (byte key, BiFunction<? super Byte, ? super Long,
     ...
     */
    public long computeIfPresent (byte key, BiFunction<? super Byte, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Byte, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TByteLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Byte, ? super Long,
