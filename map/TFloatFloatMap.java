...
public interface TFloatFloatMap {
     ...
     */
    public float compute (float key, BiFunction<? super Float, ? super Float,
     ...
     */
    public float computeIfPresent (float key, BiFunction<? super Float, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Float,
