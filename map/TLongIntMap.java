...
public interface TLongIntMap {
     ...
     */
    public int compute (long key, BiFunction<? super Long, ? super Integer,
     ...
     */
    public int computeIfPresent (long key, BiFunction<? super Long, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Integer> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongIntMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Integer,
