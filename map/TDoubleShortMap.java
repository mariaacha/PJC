...
import PJC.map.iterator.TDoubleShortIterator;
...
public interface TDoubleShortMap {
     ...
     */
    public short compute (double key, BiFunction<? super Double, ? super Short,
     ...
     */
    public short comptueIfAbsent (double key, Function<? super Double,
    		? extends Short> remappingFunction);
     ...
     */
    public short computeIfPresent (double key, BiFunction<? super Double, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Double, ? super Short> action, int numProcs);
     ...
     * associated with the key
     */
    public short merge (double key, short value, BiFunction<? super Double, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleShortMap m, int numProcs);
     ...
     */
    public void putAll (double[] keys, short[] values);
    /**
     * Copies all of the mappings from the specified arrays of keys and values to this map. 
     * The effect of this call is equivalent to that of calling <code>put (k, v)</code> on this 
     * map once for each mapping from key k to value v in the specified map. The behavior of 
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (double[] keys, short[] values, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Short,
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction<? super Double, ? super Short,
