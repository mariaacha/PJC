...
public interface TDoubleByteMap {
     ...
     */
    public byte compute (double key, BiFunction<? super Double, ? super Byte,
     ...
     */
    public byte computeIfPresent (double key, BiFunction<? super Double, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Byte,
