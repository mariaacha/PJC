...
public interface TIntByteMap {
     ...
     */
    public byte compute (int key, BiFunction<? super Integer, ? super Byte,
     ...
     */
    public byte computeIfPresent (int key, BiFunction<? super Integer, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Byte,
