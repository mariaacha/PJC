...
public interface TIntShortMap {
     ...
     */
    public short compute (int key, BiFunction<? super Integer, ? super Short,
     ...
     */
    public short computeIfPresent (int key, BiFunction<? super Integer, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntShortMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Short,
