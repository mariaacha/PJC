...
public interface TFloatCharMap {
     ...
     */
    public char compute (float key, BiFunction<? super Float, ? super Character,
     ...
     */
    public char computeIfPresent (float key, BiFunction<? super Float, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Character,
