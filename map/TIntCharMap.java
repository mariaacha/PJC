...
public interface TIntCharMap {
     ...
     */
    public char compute (int key, BiFunction<? super Integer, ? super Character,
     ...
     */
    public char computeIfPresent (int key, BiFunction<? super Integer, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Character,
