...
public interface TLongCharMap {
     ...
     */
    public char compute (long key, BiFunction<? super Long, ? super Character,
     ...
     */
    public char computeIfPresent (long key, BiFunction<? super Long, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Character,
