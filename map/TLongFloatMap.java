...
public interface TLongFloatMap {
     ...
     */
    public float compute (long key, BiFunction<? super Long, ? super Float,
     ...
     */
    public float computeIfPresent (long key, BiFunction<? super Long, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Float,
