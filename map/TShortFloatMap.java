...
public interface TShortFloatMap {
     ...
     */
    public float compute (short key, BiFunction<? super Short, ? super Float,
     ...
     */
    public float computeIfPresent (short key, BiFunction<? super Short, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Float,
