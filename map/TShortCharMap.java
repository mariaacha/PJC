...
public interface TShortCharMap {
     ...
     */
    public char compute (short key, BiFunction<? super Short, ? super Character,
     ...
     */
    public char computeIfPresent (short key, BiFunction<? super Short, ? super Character,
    		? extends Character> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Character> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Character,
