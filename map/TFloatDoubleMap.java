...
public interface TFloatDoubleMap {
     ...
     */
    public double compute (float key, BiFunction<? super Float, ? super Double,
     ...
     */
    public double computeIfPresent (float key, BiFunction<? super Float, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Double> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Double,
