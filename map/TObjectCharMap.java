...
public interface TObjectCharMap {
     ...
     */
    public char compute (Object key, BiFunction<? super Object, ? super Character,
     ...
     */
    public char computeIfPresent (Object key, BiFunction<? super Object, ? super Character,
    		? extends Character> remappingFunction);
     ...
     */
    public void putAll (Map<? extends Object, ? extends Character> m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Object, ? extends Character> m, int numProcs);
     ...
     * @param m mappings to be stored in this map
     */
    public void putAll (TObjectCharMap m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TObjectCharMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Object, ? super Character,
