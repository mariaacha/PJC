...
public interface TDoubleIntMap {
     ...
     */
    public int compute (double key, BiFunction<? super Double, ? super Integer,
     ...
     */
    public int computeIfPresent (double key, BiFunction<? super Double, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Integer> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleIntMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Integer,
