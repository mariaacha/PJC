...
public interface TFloatShortMap {
     ...
     */
    public short compute (float key, BiFunction<? super Float, ? super Short,
     ...
     */
    public short computeIfPresent (float key, BiFunction<? super Float, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatShortMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Short,
