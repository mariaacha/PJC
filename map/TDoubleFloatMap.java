...
public interface TDoubleFloatMap {
     ...
     */
    public float compute (double key, BiFunction<? super Double, ? super Float,
     ...
     */
    public float computeIfPresent (double key, BiFunction<? super Double, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Float,
