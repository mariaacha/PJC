...
public interface TCharLongMap {
     ...
     */
    public long compute (char key, BiFunction<? super Character, ? super Long,
     ...
     */
    public long computeIfPresent (char key, BiFunction<? super Character, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Long,
