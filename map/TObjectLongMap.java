...
public interface TObjectLongMap {
     ...
     */
    public long compute (Object key, BiFunction<? super Object, ? super Long,
     ...
     */
    public long computeIfPresent (Object key, BiFunction<? super Object, ? super Long,
    		? extends Long> remappingFunction);
     ...
     */
    public void putAll (Map<? extends Object, ? extends Long> m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Object, ? extends Long> m, int numProcs);
     ...
     * @param m mappings to be stored in this map
     */
    public void putAll (TObjectLongMap m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TObjectLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Object, ? super Long,
    		? extends Long> function);
