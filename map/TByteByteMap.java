...
public interface TByteByteMap {
     ...
     */
    public byte compute (byte key, BiFunction<? super Byte, ? super Byte,
     ...
     */
    public byte computeIfPresent (byte key, BiFunction<? super Byte, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Byte, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TByteByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Byte, ? super Byte,
