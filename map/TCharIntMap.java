...
public interface TCharIntMap {
     ...
     */
    public int compute (char key, BiFunction<? super Character, ? super Integer,
     ...
     */
    public int computeIfPresent (char key, BiFunction<? super Character, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Character, ? extends Integer> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TCharIntMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Character, ? super Integer,
