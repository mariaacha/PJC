...
public interface TIntIntMap {
     ...
     */
    public int compute (int key, BiFunction<? super Integer, ? super Integer,
     ...
     */
    public int comptueIfAbsent (int key, Function<? super Integer,
    		? extends Integer> remappingFunction);
     ...
     */
    public int computeIfPresent (int key, BiFunction<? super Integer, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Integer, ? super Integer> action, int numProcs);
     ...
     * associated with the key
     */
    public int merge (int key, int value, BiFunction<? super Integer, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Integer> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntIntMap m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (int[] keys, int[] values, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Integer,
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction<? super Integer, ? super Integer,
