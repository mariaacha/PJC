...
public interface TShortLongMap {
     ...
     */
    public long compute (short key, BiFunction<? super Short, ? super Long,
     ...
     */
    public long computeIfPresent (short key, BiFunction<? super Short, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Long,
