...
public interface TByteShortMap {
     ...
     */
    public short compute (byte key, BiFunction<? super Byte, ? super Short,
     ...
     */
    public short computeIfPresent (byte key, BiFunction<? super Byte, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Byte, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TByteShortMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Byte, ? super Short,
