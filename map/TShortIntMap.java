...
public interface TShortIntMap {
     ...
     */
    public int compute (short key, BiFunction<? super Short, ? super Integer,
     ...
     */
    public int computeIfPresent (short key, BiFunction<? super Short, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Short, ? extends Integer> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TShortIntMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Short, ? super Integer,
