...
public interface TDoubleObjectMap {
     ...
     */
    public Object compute (double key, BiFunction<? super Double, ? super Object,
     ...
     */
    public Object computeIfPresent (double key, BiFunction<? super Double, ? super Object,
    		? extends Object> remappingFunction);
     ...
     */
    public void putAll (Map<? extends Double, ? extends Object> m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Object> m, int numProcs);
     ...
     * @param m mappings to be stored in this map
     */
    public void putAll (TDoubleObjectMap m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleObjectMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Object,
