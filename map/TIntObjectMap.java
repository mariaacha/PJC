...
public interface TIntObjectMap {
     ...
     */
    public Object compute (int key, BiFunction<? super Integer, ? super Object,
     ...
     */
    public Object computeIfPresent (int key, BiFunction<? super Integer, ? super Object,
    		? extends Object> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Object> m, int numProcs);
     ...
     * @param m mappings to be stored in this map
     */
    public void putAll (TIntObjectMap m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntObjectMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Object,
