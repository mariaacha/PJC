...
public interface TIntLongMap {
     ...
     */
    public long compute (int key, BiFunction<? super Integer, ? super Long,
     ...
     */
    public long computeIfPresent (int key, BiFunction<? super Integer, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Integer, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TIntLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Integer, ? super Long,
