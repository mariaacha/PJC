...
public interface TDoubleLongMap {
     ...
     */
    public long compute (double key, BiFunction<? super Double, ? super Long,
     ...
     */
    public long computeIfPresent (double key, BiFunction<? super Double, ? super Long,
    		? extends Long> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Double, ? extends Long> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TDoubleLongMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Double, ? super Long,
