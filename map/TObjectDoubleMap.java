...
public interface TObjectDoubleMap {
     ...
     */
    public double compute (Object key, BiFunction<? super Object, ? super Double,
     ...
     */
    public double computeIfPresent (Object key, BiFunction<? super Object, ? super Double,
    		? extends Double> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Object, ? extends Double> m, int numProcs);
     ...
     * @param m mappings to be stored in this map
     */
    public void putAll (TObjectDoubleMap m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TObjectDoubleMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Object, ? super Double,
    		? extends Double> function);
