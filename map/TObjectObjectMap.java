...
/**
 * Interface for a primitive map of Object keys and Object values.
 */
public interface TObjectObjectMap {
     ...
     */
    public Object compute (Object key, BiFunction<? super Object, ? super Object,
     ...
     */
    public Object computeIfPresent (Object key, BiFunction<? super Object, ? super Object,
    		? extends Object> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Object, ? extends Object> m, int numProcs);
     ...
     * @param m mappings to be stored in this map
     */
    public void putAll (TObjectObjectMap m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TObjectObjectMap m, int numProcs);
