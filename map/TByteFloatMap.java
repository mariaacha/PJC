...
import PJC.map.iterator.TByteFloatIterator;
...
public interface TByteFloatMap {
     ...
     */
    public float compute (byte key, BiFunction<? super Byte, ? super Float,
     ...
     */
    public float comptueIfAbsent (byte key, Function<? super Byte,
    		? extends Float> remappingFunction);
     ...
     */
    public float computeIfPresent (byte key, BiFunction<? super Byte, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Byte, ? super Float> action, int numProcs);
     ...
     * associated with the key
     */
    public float merge (byte key, float value, BiFunction<? super Byte, ? super Float,
    		? extends Float> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Byte, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TByteFloatMap m, int numProcs);
     ...
     */
    public void putAll (byte[] keys, float[] values);
    /**
     * Copies all of the mappings from the specified arrays of keys and values to this map. 
     * The effect of this call is equivalent to that of calling <code>put (k, v)</code> on this 
     * map once for each mapping from key k to value v in the specified map. The behavior of 
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (byte[] keys, float[] values, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Byte, ? super Float,
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction<? super Byte, ? super Float,
