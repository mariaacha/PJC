...
public interface TLongShortMap {
     ...
     */
    public short compute (long key, BiFunction<? super Long, ? super Short,
     ...
     */
    public short computeIfPresent (long key, BiFunction<? super Long, ? super Short,
    		? extends Short> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Short> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongShortMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Short,
