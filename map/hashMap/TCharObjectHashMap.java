...
public class TCharObjectHashMap extends TCharObjectHash implements TCharObjectMap, Serializable, Cloneable {
     ...
     */
    public TCharObjectHashMap (int initialCapacity, float loadFactor,
        char noEntryKey, Object noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }


    /**
     * Creates a new <code>TCharObjectHashMap</code> instance containing
     ...
     */
    public TCharObjectHashMap (char[] keys, Object[] values) {
     ...
     */
    public TCharObjectHashMap (char[] keys, Object[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * all of the entries in the map passed in.
     *
     * @param map a <tt>TCharObjectMap</tt> that will be duplicated.
     */
    public TCharObjectHashMap (TCharObjectMap map) {
        super(map.size());
        if (map instanceof TCharObjectHashMap) {
            TCharObjectHashMap hashmap = (TCharObjectHashMap) map;
     ...
     * @param numProcs number of processors that will be used
     */
    public TCharObjectHashMap(TCharObjectMap map, int numProcs) {
        super(map.size());
        if (map instanceof TCharObjectHashMap) {
            TCharObjectHashMap hashmap = (TCharObjectHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TCharObjectHashMap clone() {
        TCharObjectHashMap result;
        try {
            result = (TCharObjectHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TCharObjectHashMap clonePar(int numProcs) {
        TCharObjectHashMap result;
        try {
            result = (TCharObjectHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
     ...
     */
    public Object compute (char key,
    			BiFunction<? super Character, ? super Object, ? extends Object> remappingFunction)	{
    	int index = index (key);
    	Object value = null;
    	if (index > 0)	value = remappingFunction.apply((Character)key, (Object)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public Object comptueIfAbsent (char key, Function<? super Character,
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public Object computeIfPresent (char key,
    				BiFunction<? super Character, ? super Object, ? extends Object> remappingFunction)	{
    ...
    private class Equals1 implements Runnable	{
    	TCharObjectMap that;
    	int min, max;
    	Equals1 (TCharObjectMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TCharObjectMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
     ...
     */
    public void forEach(BiConsumer<? super Character, ? super Object> action) {
        //Node<K,V>[] tab;
        if (action == null)
            throw new NullPointerException();
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Character, ? super Object> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Character, ? super Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Character, ? super Object> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TCharObjectHashMapSpliterator {
        final TCharObjectHashMap map;
        ...
        TCharObjectHashMapSpliterator(TCharObjectHashMap m, int origin,
                           int fence, int est, char no_entry_key, Object no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TCharObjectKeySpliterator
        extends TCharObjectHashMapSpliterator
        implements TCharSpliterator {
        TCharObjectKeySpliterator(TCharObjectHashMap m, int origin, int fence, int est, char no_entry, Object no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TCharObjectKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TCharObjectKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TCharObjectValueSpliterator
        extends TCharObjectHashMapSpliterator
        implements TObjectSpliterator {
        TCharObjectValueSpliterator(TCharObjectHashMap m, int origin, int fence, int est,
                         char no_entry_key, Object no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TCharObjectValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TCharObjectValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TCharSet {
        ...
        public TCharIterator iterator() {
            return new TCharObjectKeyHashIterator (TCharObjectHashMap.this);
        }
        
        /** {@inheritDoc} */
        public TCharSpliterator spliterator() {
        	return new TCharObjectKeySpliterator(TCharObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (char entry) {
            return TCharObjectHashMap.this.contains(entry);
        }
        ...
        public char[] toArrayPar (int numProcs) {
            return TCharObjectHashMap.this.keysPar(numProcs);
        }
        ...
        public char[] toArrayPar (char[] dest, int numProcs)	{
        	return TCharObjectHashMap.this.keysPar(dest, numProcs);
        }


        /**
         * Unsupported when operating upon a Key Set view of a TCharObjectMap
         * <p/>
         * {@inheritDoc}
         */
        ...
        public boolean remove (char entry) {
            return no_entry_value != TCharObjectHashMap.this.remove(entry);
        }
        /** {@inheritDoc} */
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
                    ...
                    if (array[i] instanceof Character) {
                        ...
                        if (!TCharObjectHashMap.this.containsKey(ele)) {
                            boolGlobal = false;
                            return;
                        }
                    } 
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TCharObjectHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TCharObjectHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        public boolean containsAll (char[] array) {
            for (char element : array) {
                if (!TCharObjectHashMap.this.contains(element)) {
                    return false;
                }
            }
            return true;
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TCharObjectHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TCharObjectHashMap.this.index((Character)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TCharObjectHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Character> action)	{
        	TCharObjectHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Character> action, int numProcs)	{
        	TCharObjectHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public Object merge (char key, Object value, BiFunction<? super Character, ? super Object,
    		? extends Object> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public Object putPar (char key, Object value) {
     ...
     */
    private Object doPut (char key, Object value, int index) {
      ...
      * with key
      */
     public Object putParAll (char key, Object value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private Object doPutAll(char key, Object value, int index) {
        Object previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    /** {@inheritDoc} */
    public void putAll (Map<? extends Character, ? extends Object> map) {
        ensureCapacity(map.size());
        // could optimize this for cases when map instanceof THashMap
        for (Map.Entry<? extends Character, ? extends Object> entry : map.entrySet()) {
            //this.put(entry.getKey().charValue(), entry.getValue().ObjectValue());
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Character, ? extends Object> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	char[] keys;
     	Object[] values;
     	PutAll2 (int a, int b, char[] c, Object[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TCharObjectMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (char[] keys, Object[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(char[] keys, Object[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    /** {@inheritDoc} */
    public Object replace (char key, Object value)	{
    	int index = index (key);
    	if (index > 0)	{
    ...
    /** {@inheritDoc} */
    public boolean replace (char key, Object oldValue, Object newValue)	{
    	int index = index (key);
    ...
    public void replaceAll (BiFunction 
    			<? super Character, ? super Object, ? extends Object> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	int min, max;
    	BiFunction <? super Character, ? super Object, ? extends Object> function;
    	ReplaceAll1 (int a, int b, BiFunction <? super Character, ? super Object,
			? extends Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Character, ? super Object,
    ...
    protected class TValueView implements TObjectCollection {
        ...
        public TObjectSpliterator spliterator() {
        	return new TCharObjectValueSpliterator(TCharObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (Object entry) {
            return TCharObjectHashMap.this.containsValue(entry);
        }
        @Override
        /** {@inheritDoc} */
        public boolean containsPar(Object entry, int numProcs) {
            return TCharObjectHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public Object[] toArray() {
            return TCharObjectHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public Object[] toArrayPar(int numProcs) {
            return TCharObjectHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public Object[] toArray(Object[] dest) {
            return TCharObjectHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public Object[] toArrayPar(Object[] dest, int numProcs) {
            return TCharObjectHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	Object[] values = TCharObjectHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Object) {
                    ...
                    if (!TCharObjectHashMap.this.containsValue(element)) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll (TObjectCollection collection) {
            ...
            while (iter.hasNext()) {
                if (!TCharObjectHashMap.this.containsValue(iter.next())) {
                    return false;
                }
            }
            return true;
        ...
        public void forEach (Consumer<? super Object> action)	{
        	TCharObjectHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Object> action, int numProcs)	{
        	TCharObjectHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    class TCharObjectKeyHashIterator extends THashPrimitiveIterator implements TCharIterator {
         ...
         */
        TCharObjectKeyHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TCharObjectHashMap.this.removeAt(_index);
            }
            finally {
    ...
    private class Rehash1 implements Runnable	{
    	...
    	Object[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, char[] oldK, Object[] oldV, byte[] oldS){
    ...
    public boolean adjustValue (char key, Object amount) {
        int index = index(key);
        if (index < 0) {
            return false;
        } 
    ...
    public Object adjustOrPutValue (char key, Object adjust_amount, Object put_amount) {
        int index = insertKey(key);
    ...
    class TCharObjectValueHashIterator extends THashPrimitiveIterator implements TObjectIterator {
         ...
         * @param hash the <tt>TPrimitiveHash</tt> we will be iterating over.
         */
        TCharObjectValueHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
    ...
    class TCharObjectHashIterator extends THashPrimitiveIterator implements TCharObjectIterator {
         ...
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TCharObjectHashMap</tt> we will be iterating over.
         */
        TCharObjectHashIterator (TCharObjectHashMap map) {
            super(map);
        }
