...
import PJC.hash.TDoubleObjectHash;
import PJC.iterator.TDoubleIterator;
import PJC.iterator.TObjectIterator;
import PJC.list.ArraysPar;
import PJC.map.TDoubleObjectMap;
import PJC.map.hashMap.HashFunctions;
import PJC.map.iterator.TDoubleObjectIterator;
import PJC.set.TDoubleSet;
import PJC.spliterator.TDoubleSpliterator;
import PJC.spliterator.TObjectSpliterator;

public class TDoubleObjectHashMap extends TDoubleObjectHash implements TDoubleObjectMap, Serializable, Cloneable {
     ...
     */
    public TDoubleObjectHashMap (int initialCapacity, float loadFactor,
        double noEntryKey, Object noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }


    /**
     * Creates a new <code>TDoubleObjectHashMap</code> instance containing
     ...
     */
    public TDoubleObjectHashMap (double[] keys, Object[] values) {
     ...
     */
    public TDoubleObjectHashMap (double[] keys, Object[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * all of the entries in the map passed in.
     *
     * @param map a <tt>TDoubleObjectMap</tt> that will be duplicated.
     */
    public TDoubleObjectHashMap (TDoubleObjectMap map) {
        super(map.size());
        if (map instanceof TDoubleObjectHashMap) {
            TDoubleObjectHashMap hashmap = (TDoubleObjectHashMap) map;
     ...
     * @param numProcs number of processors that will be used
     */
    public TDoubleObjectHashMap(TDoubleObjectMap map, int numProcs) {
        super(map.size());
        if (map instanceof TDoubleObjectHashMap) {
            TDoubleObjectHashMap hashmap = (TDoubleObjectHashMap) map;
            this._loadFactor = hashmap._loadFactor;
    ...
    public TDoubleObjectHashMap clone() {
        TDoubleObjectHashMap result;
        try {
            result = (TDoubleObjectHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TDoubleObjectHashMap clonePar(int numProcs) {
        TDoubleObjectHashMap result;
        try {
            result = (TDoubleObjectHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
     ...
     */
    public Object compute (double key,
    			BiFunction<? super Double, ? super Object, ? extends Object> remappingFunction)	{
    	int index = index (key);
    	Object value = null;
    	if (index > 0)	value = remappingFunction.apply((Double)key, (Object)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public Object comptueIfAbsent (double key, Function<? super Double,
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public Object computeIfPresent (double key,
    				BiFunction<? super Double, ? super Object, ? extends Object> remappingFunction)	{
    ...
    private class Equals1 implements Runnable	{
    	TDoubleObjectMap that;
    	int min, max;
    	Equals1 (TDoubleObjectMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TDoubleObjectMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
     ...
     */
    public void forEach(BiConsumer<? super Double, ? super Object> action) {
        //Node<K,V>[] tab;
        if (action == null)
            throw new NullPointerException();
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Double, ? super Object> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Double, ? super Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Double, ? super Object> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TDoubleObjectHashMapSpliterator {
        final TDoubleObjectHashMap map;
        double currentKey;				// current key
        Object currentValue;			// current value
        int index;                  // current index, modified on advance/split
        int fence;                  // one past last index
        int est;                    // size estimate
        double _no_entry_key;			// int key that represents null
        Object _no_entry_value;			// int value that represents null

        TDoubleObjectHashMapSpliterator(TDoubleObjectHashMap m, int origin,
                           int fence, int est, double no_entry_key, Object no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TDoubleObjectKeySpliterator
        extends TDoubleObjectHashMapSpliterator
        implements TDoubleSpliterator {
        TDoubleObjectKeySpliterator(TDoubleObjectHashMap m, int origin, int fence, int est, double no_entry, Object no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TDoubleObjectKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TDoubleObjectKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TDoubleObjectValueSpliterator
        extends TDoubleObjectHashMapSpliterator
        implements TObjectSpliterator {
        TDoubleObjectValueSpliterator(TDoubleObjectHashMap m, int origin, int fence, int est,
                         double no_entry_key, Object no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TDoubleObjectValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TDoubleObjectValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TDoubleSet {
        ...
        public TDoubleIterator iterator() {
            return new TDoubleObjectKeyHashIterator (TDoubleObjectHashMap.this);
        }
        
        /** {@inheritDoc} */
        public TDoubleSpliterator spliterator() {
        	return new TDoubleObjectKeySpliterator(TDoubleObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (double entry) {
            return TDoubleObjectHashMap.this.contains(entry);
        }
        ...
        public double[] toArrayPar (int numProcs) {
            return TDoubleObjectHashMap.this.keysPar(numProcs);
        }
        ...
        public double[] toArrayPar (double[] dest, int numProcs)	{
        	return TDoubleObjectHashMap.this.keysPar(dest, numProcs);
        }


        /**
         * Unsupported when operating upon a Key Set view of a TDoubleObjectMap
         * <p/>
         * {@inheritDoc}
         */
        ...
        public boolean remove (double entry) {
            return no_entry_value != TDoubleObjectHashMap.this.remove(entry);
        }
        /** {@inheritDoc} */
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
                    ...
                    if (array[i] instanceof Double) {
                        ...
                        if (!TDoubleObjectHashMap.this.containsKey(ele)) {
                            boolGlobal = false;
                            return;
                        }
                    } 
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleObjectHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	int min, max;
        	double[] array;
        	ContainsAll3 (int a, int b, double[] c)	{
        		min = a; max = b; array = c;
        	}
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleObjectHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        public boolean containsAll (double[] array) {
            for (double element : array) {
                if (!TDoubleObjectHashMap.this.contains(element)) {
                    return false;
                }
            }
            return true;
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			...
        			//if (array[i] instanceof Integer)	{
                    	if (Arrays.binarySearch(array, (Double)_set[i]) < 0)	{
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TDoubleObjectHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TDoubleObjectHashMap.this.index((Double)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        private class RemoveAll3 implements Runnable	{
        	int min, max;
        	double[] array;
        	RemoveAll3 (int a, int b, double[] c)	{
        		min = a; max = b; array = c;
        	}
        	public void run ()	{
        		int removed = 0;
        ...
        public boolean removeAllPar2 (double[] array, int numProcs)	{
        	atIntGlobal = new AtomicInteger(0);
        	Arrays.sort(array);
        	int oldSize = _size;
        	int numElemProc = _set.length/numProcs;
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TDoubleObjectHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Double> action)	{
        	TDoubleObjectHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Double> action, int numProcs)	{
        	TDoubleObjectHashMap.this.forEachKeyPar (action, numProcs);
        }
        ...
        private class Equals1 implements Runnable	{
        	int min, max;
        	TDoubleSet that;
        	Equals1 (int a, int b, TDoubleSet c)	{
        		min = a; max = b; that = c;
        	}
        	public void run ()	{
        		for (int i=min; i<max; i++)	{
        ...
        public boolean equalsPar (Object o, int numProcs)	{
        	boolGlobal = false;
        	if (o instanceof TDoubleSet)	{
        		TDoubleSet that = (TDoubleSet) o;
    ...
    /** {@inheritDoc} */
    public Object merge (double key, Object value, BiFunction<? super Double, ? super Object,
    		? extends Object> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public Object putPar (double key, Object value) {
     ...
     */
    private Object doPut (double key, Object value, int index) {
      ...
      * with key
      */
     public Object putParAll (double key, Object value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private Object doPutAll(double key, Object value, int index) {
        Object previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    /** {@inheritDoc} */
    public void putAll (Map<? extends Double, ? extends Object> map) {
        ensureCapacity(map.size());
        // could optimize this for cases when map instanceof THashMap
        for (Map.Entry<? extends Double, ? extends Object> entry : map.entrySet()) {
            //this.put(entry.getKey().doubleValue(), entry.getValue().ObjectValue());
        	this.put(entry.getKey().doubleValue(), entry.getValue());
        }
    }
     	...
     	public void run ()	{
     		...
     		for (int i=min; i<max; i++)	{
     			if (entradas[i].getKey() instanceof Integer)	{
     				clave = ((Double) entradas[i].getKey()).doubleValue();
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Double, ? extends Object> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	double[] keys;
     	Object[] values;
     	PutAll2 (int a, int b, double[] c, Object[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TDoubleObjectMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
         double[] set = map.keySet().toArrayPar(numProcs);
     ...
     /** {@inheritDoc} */
     public void putAll (double[] keys, Object[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(double[] keys, Object[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    /** {@inheritDoc} */
    public Object putIfAbsent (double key, Object value) {
        int index = insertKey(key);
        if (index < 0)
    ...
    /** {@inheritDoc} */
    public Object replace (double key, Object value)	{
    	int index = index (key);
    	if (index > 0)	{
    ...
    /** {@inheritDoc} */
    public boolean replace (double key, Object oldValue, Object newValue)	{
    	int index = index (key);
    ...
    public void replaceAll (BiFunction 
    			<? super Double, ? super Object, ? extends Object> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	int min, max;
    	BiFunction <? super Double, ? super Object, ? extends Object> function;
    	ReplaceAll1 (int a, int b, BiFunction <? super Double, ? super Object,
			? extends Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Double, ? super Object,
    ...
    protected class TValueView implements TObjectCollection {
        ...
        public TObjectSpliterator spliterator() {
        	return new TDoubleObjectValueSpliterator(TDoubleObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (Object entry) {
            return TDoubleObjectHashMap.this.containsValue(entry);
        }
        @Override
        /** {@inheritDoc} */
        public boolean containsPar(Object entry, int numProcs) {
            return TDoubleObjectHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public Object[] toArray() {
            return TDoubleObjectHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public Object[] toArrayPar(int numProcs) {
            return TDoubleObjectHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public Object[] toArray(Object[] dest) {
            return TDoubleObjectHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public Object[] toArrayPar(Object[] dest, int numProcs) {
            return TDoubleObjectHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	Object[] values = TDoubleObjectHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Object) {
                    ...
                    if (!TDoubleObjectHashMap.this.containsValue(element)) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll (TObjectCollection collection) {
            ...
            while (iter.hasNext()) {
                if (!TDoubleObjectHashMap.this.containsValue(iter.next())) {
                    return false;
                }
            }
            return true;
        ...
        public void forEach (Consumer<? super Object> action)	{
        	TDoubleObjectHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Object> action, int numProcs)	{
        	TDoubleObjectHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    class TDoubleObjectKeyHashIterator extends THashPrimitiveIterator implements TDoubleIterator {
         ...
         */
        TDoubleObjectKeyHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TDoubleObjectHashMap.this.removeAt(_index);
            }
            finally {
    ...
    private class Rehash1 implements Runnable	{
    	...
    	Object[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, double[] oldK, Object[] oldV, byte[] oldS){
    ...
    private class Keys1 implements Runnable	{
    	...
    	public void run()	{
    		...
    		if (idProc > 0)	{
        		...
        		if (j>0)
    			System.arraycopy(doublesLocal, 0, doublesGlobal, size, j);
        	}
    		else 	{
    			atIntGlobal.addAndGet(j);
        		intsGlobal2[idProc] = j;
    ...
    protected double[] keysPar(int numProcs)	{
    	int numElemProc = _set.length/numProcs;
    	atIntGlobal = new AtomicInteger(0);
    ...
    /** {@inheritDoc} */
    protected double[] keysPar (double[] array, int numProcs) {
        int size = size();
    ...
    /** {@inheritDoc} */
    protected double[] keys (double[] array) {
        int size = size();
        if (array.length < size) {
            array = new double[size];
        }
    ...
    /** {@inheritDoc} */
    protected void forEachKey (Consumer<? super Double> action)	{
    	for (int i=0; i<_set.length; i++)	{
    		if (_states[i] == FULL)
    ...
    private class ForEachKey1 implements Runnable	{
    	...
    	ForEachKey1 (int a, int b, Consumer<? super Double> c)	{
    		min = a; max = b; action = c;
    	}
    	public void run ()	{
    		for (int i=min; i<max; i++)
    ...
    /** {@inheritDoc} */
    protected void forEachKeyPar (Consumer<? super Double> action, int numProcs)	{
    	int numElemProc = _set.length/numProcs;
    	int numMin, numMax;
    	threads = new Thread[numProcs];
    	for (int i=0; i<numProcs; i++)	{
    ...
    public boolean adjustValue (double key, Object amount) {
        int index = index(key);
        if (index < 0) {
            return false;
        } 
    ...
    public Object adjustOrPutValue (double key, Object adjust_amount, Object put_amount) {
        int index = insertKey(key);
    ...
    class TDoubleObjectValueHashIterator extends THashPrimitiveIterator implements TObjectIterator {
         ...
         * @param hash the <tt>TPrimitiveHash</tt> we will be iterating over.
         */
        TDoubleObjectValueHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
    ...
    class TDoubleObjectHashIterator extends THashPrimitiveIterator implements TDoubleObjectIterator {
         ...
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TDoubleObjectHashMap</tt> we will be iterating over.
         */
        TDoubleObjectHashIterator (TDoubleObjectHashMap map) {
            super(map);
        }
