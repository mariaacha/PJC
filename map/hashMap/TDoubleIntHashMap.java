...
public class TDoubleIntHashMap extends TDoubleIntHash implements TDoubleIntMap, Serializable, Cloneable {
     ...
     */
    public TDoubleIntHashMap (double[] keys, int[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * @param numProcs number of processors that will be used
     */
    public TDoubleIntHashMap(TDoubleIntMap map, int numProcs) {
        super(map.size());
        if (map instanceof TDoubleIntHashMap) {
            TDoubleIntHashMap hashmap = (TDoubleIntHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TDoubleIntHashMap clone() {
        TDoubleIntHashMap result;
        try {
            result = (TDoubleIntHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TDoubleIntHashMap clonePar(int numProcs) {
        TDoubleIntHashMap result;
        try {
            result = (TDoubleIntHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
     ...
     */
    public int compute (double key,
    			BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction)	{
    	int index = index (key);
    	Integer value = null;
    	if (index > 0)	value = remappingFunction.apply((Double)key, (Integer)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public int comptueIfAbsent (double key, Function<? super Double,
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public int computeIfPresent (double key,
    				BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction)	{
    ...
    private class Equals1 implements Runnable	{
    	TDoubleIntMap that;
    	int min, max;
    	Equals1 (TDoubleIntMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TDoubleIntMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Double, ? super Integer> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Double, ? super Integer> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Double, ? super Integer> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TDoubleIntHashMapSpliterator {
        final TDoubleIntHashMap map;
        ...
        TDoubleIntHashMapSpliterator(TDoubleIntHashMap m, int origin,
                           int fence, int est, double no_entry_key, int no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TDoubleIntKeySpliterator
        extends TDoubleIntHashMapSpliterator
        implements TDoubleSpliterator {
        TDoubleIntKeySpliterator(TDoubleIntHashMap m, int origin, int fence, int est, double no_entry, int no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TDoubleIntKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TDoubleIntKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TDoubleIntValueSpliterator
        extends TDoubleIntHashMapSpliterator
        implements TIntSpliterator {
        TDoubleIntValueSpliterator(TDoubleIntHashMap m, int origin, int fence, int est,
                         double no_entry_key, int no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TDoubleIntValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TDoubleIntValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TDoubleSet {
        ...
        public TDoubleSpliterator spliterator() {
        	return new TDoubleIntKeySpliterator(TDoubleIntHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public double[] toArrayPar (int numProcs) {
            return TDoubleIntHashMap.this.keysPar(numProcs);
        }
        ...
        public double[] toArrayPar (double[] dest, int numProcs)	{
        	return TDoubleIntHashMap.this.keysPar(dest, numProcs);
        }
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleIntHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleIntHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TDoubleIntHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TDoubleIntHashMap.this.index((Double)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TDoubleIntHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Double> action)	{
        	TDoubleIntHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Double> action, int numProcs)	{
        	TDoubleIntHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public int merge (double key, int value, BiFunction<? super Double, ? super Integer,
    		? extends Integer> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public int putPar (double key, int value) {
    ...
    private int doPut (double key, int value, int index) {
      ...
      * with key
      */
     public int putParAll (double key, int value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private int doPutAll(double key, int value, int index) {
        int previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    public void putAll (Map<? extends Double, ? extends Integer> map) {
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Double, ? extends Integer> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	double[] keys;
     	int[] values;
     	PutAll2 (int a, int b, double[] c, int[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TDoubleIntMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (double[] keys, int[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(double[] keys, int[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    public void replaceAll (BiFunction 
    			<? super Double, ? super Integer, ? extends Integer> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	...
    	ReplaceAll1 (int a, int b, BiFunction <? super Double, ? super Integer,
			? extends Integer> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Double, ? super Integer,
    ...
    protected class TValueView implements TIntCollection {
        ...
        public TIntSpliterator spliterator() {
        	return new TDoubleIntValueSpliterator(TDoubleIntHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean containsPar(int entry, int numProcs) {
            return TDoubleIntHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public int[] toArray() {
            return TDoubleIntHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public int[] toArrayPar(int numProcs) {
            return TDoubleIntHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public int[] toArray(int[] dest) {
            return TDoubleIntHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public int[] toArrayPar(int[] dest, int numProcs) {
            return TDoubleIntHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	int[] values = TDoubleIntHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public void forEach (Consumer<? super Integer> action)	{
        	TDoubleIntHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Integer> action, int numProcs)	{
        	TDoubleIntHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    private class Rehash1 implements Runnable	{
    	...
    	int[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, double[] oldK, int[] oldV, byte[] oldS){
