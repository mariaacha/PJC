...
public class TDoubleFloatHashMap extends TDoubleFloatHash implements TDoubleFloatMap, Serializable, Cloneable {
     ...
     */
    public TDoubleFloatHashMap (double[] keys, float[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * @param numProcs number of processors that will be used
     */
    public TDoubleFloatHashMap(TDoubleFloatMap map, int numProcs) {
        super(map.size());
        if (map instanceof TDoubleFloatHashMap) {
            TDoubleFloatHashMap hashmap = (TDoubleFloatHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TDoubleFloatHashMap clone() {
        TDoubleFloatHashMap result;
        try {
            result = (TDoubleFloatHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TDoubleFloatHashMap clonePar(int numProcs) {
        TDoubleFloatHashMap result;
        try {
            result = (TDoubleFloatHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
    ...
    public float compute (double key,
    	...
    	int index = index (key);
    	Float value = null;
    	if (index > 0)	value = remappingFunction.apply((Double)key, (Float)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public float comptueIfAbsent (double key, Function<? super Double,
    ...
    private class Equals1 implements Runnable	{
    	TDoubleFloatMap that;
    	int min, max;
    	Equals1 (TDoubleFloatMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TDoubleFloatMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Double, ? super Float> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Double, ? super Float> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Double, ? super Float> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TDoubleFloatHashMapSpliterator {
        final TDoubleFloatHashMap map;
        ...
        TDoubleFloatHashMapSpliterator(TDoubleFloatHashMap m, int origin,
                           int fence, int est, double no_entry_key, float no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TDoubleFloatKeySpliterator
        extends TDoubleFloatHashMapSpliterator
        implements TDoubleSpliterator {
        TDoubleFloatKeySpliterator(TDoubleFloatHashMap m, int origin, int fence, int est, double no_entry, float no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TDoubleFloatKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TDoubleFloatKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TDoubleFloatValueSpliterator
        extends TDoubleFloatHashMapSpliterator
        implements TFloatSpliterator {
        TDoubleFloatValueSpliterator(TDoubleFloatHashMap m, int origin, int fence, int est,
                         double no_entry_key, float no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TDoubleFloatValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TDoubleFloatValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TDoubleSet {
        ...
        public TDoubleSpliterator spliterator() {
        	return new TDoubleFloatKeySpliterator(TDoubleFloatHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public double[] toArrayPar (int numProcs) {
            return TDoubleFloatHashMap.this.keysPar(numProcs);
        }
        ...
        public double[] toArrayPar (double[] dest, int numProcs)	{
        	return TDoubleFloatHashMap.this.keysPar(dest, numProcs);
        }
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleFloatHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleFloatHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TDoubleFloatHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TDoubleFloatHashMap.this.index((Double)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TDoubleFloatHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Double> action)	{
        	TDoubleFloatHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Double> action, int numProcs)	{
        	TDoubleFloatHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public float merge (double key, float value, BiFunction<? super Double, ? super Float,
    		? extends Float> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public float putPar (double key, float value) {
    ...
    private float doPut (double key, float value, int index) {
      ...
      * with key
      */
     public float putParAll (double key, float value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private float doPutAll(double key, float value, int index) {
        float previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    public void putAll (Map<? extends Double, ? extends Float> map) {
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Double, ? extends Float> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	double[] keys;
     	float[] values;
     	PutAll2 (int a, int b, double[] c, float[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TDoubleFloatMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (double[] keys, float[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(double[] keys, float[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    public void replaceAll (BiFunction 
    			<? super Double, ? super Float, ? extends Float> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	...
    	ReplaceAll1 (int a, int b, BiFunction <? super Double, ? super Float,
			? extends Float> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Double, ? super Float,
    ...
    protected class TValueView implements TFloatCollection {
        ...
        public TFloatSpliterator spliterator() {
        	return new TDoubleFloatValueSpliterator(TDoubleFloatHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean containsPar(float entry, int numProcs) {
            return TDoubleFloatHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public float[] toArray() {
            return TDoubleFloatHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public float[] toArrayPar(int numProcs) {
            return TDoubleFloatHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public float[] toArray(float[] dest) {
            return TDoubleFloatHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public float[] toArrayPar(float[] dest, int numProcs) {
            return TDoubleFloatHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	float[] values = TDoubleFloatHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public void forEach (Consumer<? super Float> action)	{
        	TDoubleFloatHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Float> action, int numProcs)	{
        	TDoubleFloatHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    private class Rehash1 implements Runnable	{
    	...
    	float[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, double[] oldK, float[] oldV, byte[] oldS){
