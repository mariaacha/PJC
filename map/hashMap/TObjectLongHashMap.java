...
public class TObjectLongHashMap extends TObjectLongHash implements TObjectLongMap, Serializable, Cloneable {
     ...
     */
    public TObjectLongHashMap (int initialCapacity, float loadFactor,
        Object noEntryKey, long noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }


    /**
     * Creates a new <code>TObjectLongHashMap</code> instance containing
     ...
     */
    public TObjectLongHashMap (Object[] keys, long[] values) {
     ...
     */
    public TObjectLongHashMap (Object[] keys, long[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * all of the entries in the map passed in.
     *
     * @param map a <tt>TObjectLongMap</tt> that will be duplicated.
     */
    public TObjectLongHashMap (TObjectLongMap map) {
        super(map.size());
     ...
     * @param numProcs number of processors that will be used
     */
    public TObjectLongHashMap(TObjectLongMap map, int numProcs) {
        super(map.size());
        if (map instanceof TObjectLongHashMap) {
            TObjectLongHashMap hashmap = (TObjectLongHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TObjectLongHashMap clone() {
        TObjectLongHashMap result;
        try {
            result = (TObjectLongHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TObjectLongHashMap clonePar(int numProcs) {
        TObjectLongHashMap result;
        try {
            result = (TObjectLongHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
     ...
     */
    public long compute (Object key,
    			BiFunction<? super Object, ? super Long, ? extends Long> remappingFunction)	{
    	int index = index (key);
    	Long value = null;
    	if (index > 0)	value = remappingFunction.apply((Object)key, (Long)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public long comptueIfAbsent (Object key, Function<? super Object,
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public long computeIfPresent (Object key,
    				BiFunction<? super Object, ? super Long, ? extends Long> remappingFunction)	{
    ...
    private class Equals1 implements Runnable	{
    	TObjectLongMap that;
    	int min, max;
    	Equals1 (TObjectLongMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TObjectLongMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
     ...
     */
    public void forEach(BiConsumer<? super Object, ? super Long> action) {
        //Node<K,V>[] tab;
        if (action == null)
            throw new NullPointerException();
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Object, ? super Long> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Object, ? super Long> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Object, ? super Long> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TObjectLongHashMapSpliterator {
        final TObjectLongHashMap map;
        ...
        TObjectLongHashMapSpliterator(TObjectLongHashMap m, int origin,
                           int fence, int est, Object no_entry_key, long no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TObjectLongKeySpliterator
        extends TObjectLongHashMapSpliterator
        implements TObjectSpliterator {
        TObjectLongKeySpliterator(TObjectLongHashMap m, int origin, int fence, int est, Object no_entry, long no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TObjectLongKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TObjectLongKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TObjectLongValueSpliterator
        extends TObjectLongHashMapSpliterator
        implements TLongSpliterator {
        TObjectLongValueSpliterator(TObjectLongHashMap m, int origin, int fence, int est,
                         Object no_entry_key, long no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TObjectLongValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TObjectLongValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TObjectSet {
        ...
        public TObjectIterator iterator() {
            return new TObjectLongKeyHashIterator (TObjectLongHashMap.this);
        }
        
        /** {@inheritDoc} */
        public TObjectSpliterator spliterator() {
        	return new TObjectLongKeySpliterator(TObjectLongHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (Object entry) {
            return TObjectLongHashMap.this.contains(entry);
        }
        ...
        public Object[] toArray() {
            return TObjectLongHashMap.this.keys();
        }

        /** {@inheritDoc} */
        public Object[] toArrayPar (int numProcs) {
            return TObjectLongHashMap.this.keysPar(numProcs);
        }

        /** {@inheritDoc} */
        public Object[] toArray (Object[] dest) {
            return TObjectLongHashMap.this.keys(dest);
        }
        public Object[] toArrayPar (Object[] dest, int numProcs)	{
        	return TObjectLongHashMap.this.keysPar(dest, numProcs);
        }


        /**
         * Unsupported when operating upon a Key Set view of a TObjectLongMap
         * <p/>
         * {@inheritDoc}
         */
        ...
        public boolean remove (Object entry) {
            return no_entry_value != TObjectLongHashMap.this.remove(entry);
        }
        /** {@inheritDoc} */
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
                    ...
                    if (array[i] instanceof Object) {
                    	...
                    	Object ele = array[i];
                        if (!TObjectLongHashMap.this.containsKey(ele)) {
                            boolGlobal = false;
                            return;
                        }
                    } 
        ...
        public boolean containsAll (Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Object) {
                    ...
                    if (!TObjectLongHashMap.this.containsKey(element)) {
                        return false;
                    }
                } else {
                    return false;
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TObjectLongHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        public boolean containsAll (TObjectCollection collection) {
            ...
            while (iter.hasNext()) {
                if (!TObjectLongHashMap.this.containsKey(iter.next())) {
                    return false;
                }
            }
            return true;
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TObjectLongHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        public boolean containsAll (Object[] array) {
            for (Object element : array) {
                if (!TObjectLongHashMap.this.contains(element)) {
                    return false;
                }
            }
            return true;
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TObjectLongHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TObjectLongHashMap.this.index((Object)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TObjectLongHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Object> action)	{
        	TObjectLongHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Object> action, int numProcs)	{
        	TObjectLongHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public long merge (Object key, long value, BiFunction<? super Object, ? super Long,
    		? extends Long> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public long putPar (Object key, long value) {
     ...
     */
    private long doPut (Object key, long value, int index) {
      ...
      * with key
      */
     public long putParAll (Object key, long value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private long doPutAll(Object key, long value, int index) {
        long previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    /** {@inheritDoc} */
    public void putAll (Map<? extends Object, ? extends Long> map) {
        ensureCapacity(map.size());
        // could optimize this for cases when map instanceof THashMap
        for (Map.Entry<? extends Object, ? extends Long> entry : map.entrySet()) {
            //this.put(entry.getKey().ObjectValue(), entry.getValue().longValue());
        	this.put(entry.getKey(), entry.getValue().longValue());
        }
    }
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Object, ? extends Long> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	Object[] keys;
     	long[] values;
     	PutAll2 (int a, int b, Object[] c, long[] d)	{
     ...
     /** {@inheritDoc} */
     public void putAll (TObjectLongMap map) {
         ensureCapacity(map.size());
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TObjectLongMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (Object[] keys, long[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Object[] keys, long[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    /** {@inheritDoc} */
    public long putIfAbsent (Object key, long value) {
        int index = insertKey(key);
        if (index < 0)
    ...
    /** {@inheritDoc} */
    public long replace (Object key, long value)	{
    	int index = index (key);
    	if (index > 0)	{
    ...
    /** {@inheritDoc} */
    public boolean replace (Object key, long oldValue, long newValue)	{
    	int index = index (key);
    ...
    public void replaceAll (BiFunction 
    			<? super Object, ? super Long, ? extends Long> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	int min, max;
    	BiFunction <? super Object, ? super Long, ? extends Long> function;
    	ReplaceAll1 (int a, int b, BiFunction <? super Object, ? super Long,
			? extends Long> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Object, ? super Long,
    ...
    protected class TValueView implements TLongCollection {
        ...
        public TLongIterator iterator() {
            return new TObjectLongValueHashIterator(TObjectLongHashMap.this);
        }

        /** {@inheritDoc} */
        public TLongSpliterator spliterator() {
        	return new TObjectLongValueSpliterator(TObjectLongHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean containsPar(long entry, int numProcs) {
            return TObjectLongHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public long[] toArray() {
            return TObjectLongHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public long[] toArrayPar(int numProcs) {
            return TObjectLongHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public long[] toArray(long[] dest) {
            return TObjectLongHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public long[] toArrayPar(long[] dest, int numProcs) {
            return TObjectLongHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	int numElemProc = collection.size()/numProcs;
        	Object[] array = collection.toArray (new Object[collection.size()]);
        	long[] values = TObjectLongHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public void forEach (Consumer<? super Long> action)	{
        	TObjectLongHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Long> action, int numProcs)	{
        	TObjectLongHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    class TObjectLongKeyHashIterator extends THashPrimitiveIterator implements TObjectIterator {
         ...
         */
        TObjectLongKeyHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
    ...
    private class Rehash1 implements Runnable	{
    	...
    	long[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, Object[] oldK, long[] oldV, byte[] oldS){
    ...
    /** {@inheritDoc} */
    public long adjustOrPutValue (Object key, long adjust_amount, long put_amount) {
        int index = insertKey(key);
    ...
    class TObjectLongValueHashIterator extends THashPrimitiveIterator implements TLongIterator {
         ...
         * @param hash the <tt>TPrimitiveHash</tt> we will be iterating over.
         */
        TObjectLongValueHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
    ...
    class TObjectLongHashIterator extends THashPrimitiveIterator implements TObjectLongIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TObjectLongHashMap</tt> we will be iterating over.
         */
        TObjectLongHashIterator (TObjectLongHashMap map) {
            super(map);
        }
