...
//import paralel.collection.TLongCollection;
//import paralel.collection.TObjectCollection;
//import paralel.iterator.TLongIterator;
//import paralel.spliterator.TLongSpliterator;
...
import PJC.hash.TLongLongHash;
import PJC.iterator.TLongIterator;
import PJC.list.ArraysPar;
import PJC.map.TLongLongMap;
import PJC.map.hashMap.HashFunctions;
import PJC.map.iterator.TLongLongIterator;
import PJC.set.TLongSet;
import PJC.spliterator.TLongSpliterator;

public class TLongLongHashMap extends TLongLongHash implements TLongLongMap, Serializable, Cloneable {
     ...
     */
    public TLongLongHashMap (long[] keys, long[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * @param numProcs number of processors that will be used
     */
    public TLongLongHashMap(TLongLongMap map, int numProcs) {
        super(map.size());
        if (map instanceof TLongLongHashMap) {
            TLongLongHashMap hashmap = (TLongLongHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TLongLongHashMap clone() {
        TLongLongHashMap result;
        try {
            result = (TLongLongHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TLongLongHashMap clonePar(int numProcs) {
        TLongLongHashMap result;
        try {
            result = (TLongLongHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
    ...
    public long compute (long key,
    	...
    	int index = index (key);
    	Long value = null;
    	if (index > 0)	value = remappingFunction.apply((Long)key, (Long)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public long comptueIfAbsent (long key, Function<? super Long,
    ...
    private class Equals1 implements Runnable	{
    	TLongLongMap that;
    	int min, max;
    	Equals1 (TLongLongMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TLongLongMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Long, ? super Long> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Long, ? super Long> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Long, ? super Long> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TLongLongHashMapSpliterator {
        final TLongLongHashMap map;
        ...
        TLongLongHashMapSpliterator(TLongLongHashMap m, int origin,
                           int fence, int est, long no_entry_key, long no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TLongLongKeySpliterator
        extends TLongLongHashMapSpliterator
        implements TLongSpliterator {
        TLongLongKeySpliterator(TLongLongHashMap m, int origin, int fence, int est, long no_entry, long no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TLongLongKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TLongLongKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TLongLongValueSpliterator
        extends TLongLongHashMapSpliterator
        implements TLongSpliterator {
        TLongLongValueSpliterator(TLongLongHashMap m, int origin, int fence, int est,
                         long no_entry_key, long no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TLongLongValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TLongLongValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TLongSet {
        ...
        public TLongSpliterator spliterator() {
        	return new TLongLongKeySpliterator(TLongLongHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public long[] toArrayPar (int numProcs) {
            return TLongLongHashMap.this.keysPar(numProcs);
        }
        ...
        public long[] toArrayPar (long[] dest, int numProcs)	{
        	return TLongLongHashMap.this.keysPar(dest, numProcs);
        }
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TLongLongHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TLongLongHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TLongLongHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TLongLongHashMap.this.index((Long)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TLongLongHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Long> action)	{
        	TLongLongHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Long> action, int numProcs)	{
        	TLongLongHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public long merge (long key, long value, BiFunction<? super Long, ? super Long,
    		? extends Long> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public long putPar (long key, long value) {
    ...
    private long doPut (long key, long value, int index) {
      ...
      * with key
      */
     public long putParAll (long key, long value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private long doPutAll(long key, long value, int index) {
        long previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    public void putAll (Map<? extends Long, ? extends Long> map) {
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Long, ? extends Long> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	long[] keys;
     	long[] values;
     	PutAll2 (int a, int b, long[] c, long[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TLongLongMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(long[] keys, long[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    public void replaceAll (BiFunction 
    			<? super Long, ? super Long, ? extends Long> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	...
    	ReplaceAll1 (int a, int b, BiFunction <? super Long, ? super Long,
			? extends Long> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Long, ? super Long,
    ...
    protected class TValueView implements TLongCollection {
        ...
        /** {@inheritDoc} */
        public TLongSpliterator spliterator() {
        	return new TLongLongValueSpliterator(TLongLongHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        /** {@inheritDoc} */
        public boolean containsPar(long entry, int numProcs) {
            return TLongLongHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public long[] toArray() {
            return TLongLongHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public long[] toArrayPar(int numProcs) {
            return TLongLongHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public long[] toArray(long[] dest) {
            return TLongLongHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public long[] toArrayPar(long[] dest, int numProcs) {
            return TLongLongHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	long[] values = TLongLongHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        /** {@inheritDoc} */
        public void forEach (Consumer<? super Long> action)	{
        	TLongLongHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Long> action, int numProcs)	{
        	TLongLongHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    private class Rehash1 implements Runnable	{
    	...
    	long[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, long[] oldK, long[] oldV, byte[] oldS){
