...
public class TLongObjectHashMap extends TLongObjectHash implements TLongObjectMap, Serializable, Cloneable {
     ...
     */
    public TLongObjectHashMap (int initialCapacity, float loadFactor,
        long noEntryKey, Object noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }


    /**
     * Creates a new <code>TLongObjectHashMap</code> instance containing
     ...
     */
    public TLongObjectHashMap (long[] keys, Object[] values) {
     ...
     */
    public TLongObjectHashMap (long[] keys, Object[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * all of the entries in the map passed in.
     *
     * @param map a <tt>TLongObjectMap</tt> that will be duplicated.
     */
    public TLongObjectHashMap (TLongObjectMap map) {
        super(map.size());
        if (map instanceof TLongObjectHashMap) {
            TLongObjectHashMap hashmap = (TLongObjectHashMap) map;
     ...
     * @param numProcs number of processors that will be used
     */
    public TLongObjectHashMap(TLongObjectMap map, int numProcs) {
        super(map.size());
        if (map instanceof TLongObjectHashMap) {
            TLongObjectHashMap hashmap = (TLongObjectHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TLongObjectHashMap clone() {
        TLongObjectHashMap result;
        try {
            result = (TLongObjectHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TLongObjectHashMap clonePar(int numProcs) {
        TLongObjectHashMap result;
        try {
            result = (TLongObjectHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
     ...
     */
    public Object compute (long key,
    			BiFunction<? super Long, ? super Object, ? extends Object> remappingFunction)	{
    	int index = index (key);
    	Object value = null;
    	if (index > 0)	value = remappingFunction.apply((Long)key, (Object)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public Object comptueIfAbsent (long key, Function<? super Long,
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public Object computeIfPresent (long key,
    				BiFunction<? super Long, ? super Object, ? extends Object> remappingFunction)	{
    ...
    private class Equals1 implements Runnable	{
    	TLongObjectMap that;
    	int min, max;
    	Equals1 (TLongObjectMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TLongObjectMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
     ...
     */
    public void forEach(BiConsumer<? super Long, ? super Object> action) {
        //Node<K,V>[] tab;
        if (action == null)
            throw new NullPointerException();
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Long, ? super Object> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Long, ? super Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Long, ? super Object> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TLongObjectHashMapSpliterator {
        final TLongObjectHashMap map;
        ...
        TLongObjectHashMapSpliterator(TLongObjectHashMap m, int origin,
                           int fence, int est, long no_entry_key, Object no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TLongObjectKeySpliterator
        extends TLongObjectHashMapSpliterator
        implements TLongSpliterator {
        TLongObjectKeySpliterator(TLongObjectHashMap m, int origin, int fence, int est, long no_entry, Object no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TLongObjectKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TLongObjectKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TLongObjectValueSpliterator
        extends TLongObjectHashMapSpliterator
        implements TObjectSpliterator {
        TLongObjectValueSpliterator(TLongObjectHashMap m, int origin, int fence, int est,
                         long no_entry_key, Object no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TLongObjectValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TLongObjectValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TLongSet {
        ...
        public TLongIterator iterator() {
            return new TLongObjectKeyHashIterator (TLongObjectHashMap.this);
        }
        
        /** {@inheritDoc} */
        public TLongSpliterator spliterator() {
        	return new TLongObjectKeySpliterator(TLongObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (long entry) {
            return TLongObjectHashMap.this.contains(entry);
        }
        ...
        public long[] toArrayPar (int numProcs) {
            return TLongObjectHashMap.this.keysPar(numProcs);
        }
        ...
        public long[] toArrayPar (long[] dest, int numProcs)	{
        	return TLongObjectHashMap.this.keysPar(dest, numProcs);
        }


        /**
         * Unsupported when operating upon a Key Set view of a TLongObjectMap
         * <p/>
         * {@inheritDoc}
         */
        ...
        public boolean remove (long entry) {
            return no_entry_value != TLongObjectHashMap.this.remove(entry);
        }
        /** {@inheritDoc} */
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
                    ...
                    if (array[i] instanceof Long) {
                        ...
                        if (!TLongObjectHashMap.this.containsKey(ele)) {
                            boolGlobal = false;
                            return;
                        }
                    } 
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TLongObjectHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TLongObjectHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        public boolean containsAll (long[] array) {
            for (long element : array) {
                if (!TLongObjectHashMap.this.contains(element)) {
                    return false;
                }
            }
            return true;
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TLongObjectHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TLongObjectHashMap.this.index((Long)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TLongObjectHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Long> action)	{
        	TLongObjectHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Long> action, int numProcs)	{
        	TLongObjectHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public Object merge (long key, Object value, BiFunction<? super Long, ? super Object,
    		? extends Object> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public Object putPar (long key, Object value) {
     ...
     */
    private Object doPut (long key, Object value, int index) {
      ...
      * with key
      */
     public Object putParAll (long key, Object value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private Object doPutAll(long key, Object value, int index) {
        Object previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    public void putAll (Map<? extends Long, ? extends Object> map) {
        ...
        for (Map.Entry<? extends Long, ? extends Object> entry : map.entrySet()) {
            //this.put(entry.getKey().longValue(), entry.getValue().ObjectValue());
        	this.put(entry.getKey().longValue(), entry.getValue());
        }
    }
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Long, ? extends Object> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	long[] keys;
     	Object[] values;
     	PutAll2 (int a, int b, long[] c, Object[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TLongObjectMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (long[] keys, Object[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(long[] keys, Object[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    /** {@inheritDoc} */
    public Object replace (long key, Object value)	{
    	int index = index (key);
    	if (index > 0)	{
    ...
    /** {@inheritDoc} */
    public boolean replace (long key, Object oldValue, Object newValue)	{
    	int index = index (key);
    ...
    public void replaceAll (BiFunction 
    			<? super Long, ? super Object, ? extends Object> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	int min, max;
    	BiFunction <? super Long, ? super Object, ? extends Object> function;
    	ReplaceAll1 (int a, int b, BiFunction <? super Long, ? super Object,
			? extends Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Long, ? super Object,
    ...
    protected class TValueView implements TObjectCollection {
        ...
        public TObjectSpliterator spliterator() {
        	return new TLongObjectValueSpliterator(TLongObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (Object entry) {
            return TLongObjectHashMap.this.containsValue(entry);
        }
        @Override
        /** {@inheritDoc} */
        public boolean containsPar(Object entry, int numProcs) {
            return TLongObjectHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public Object[] toArray() {
            return TLongObjectHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public Object[] toArrayPar(int numProcs) {
            return TLongObjectHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public Object[] toArray(Object[] dest) {
            return TLongObjectHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public Object[] toArrayPar(Object[] dest, int numProcs) {
            return TLongObjectHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	Object[] values = TLongObjectHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Object) {
                    ...
                    if (!TLongObjectHashMap.this.containsValue(element)) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll (TObjectCollection collection) {
            ...
            while (iter.hasNext()) {
                if (!TLongObjectHashMap.this.containsValue(iter.next())) {
                    return false;
                }
            }
            return true;
        ...
        public void forEach (Consumer<? super Object> action)	{
        	TLongObjectHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Object> action, int numProcs)	{
        	TLongObjectHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    class TLongObjectKeyHashIterator extends THashPrimitiveIterator implements TLongIterator {
         ...
         */
        TLongObjectKeyHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TLongObjectHashMap.this.removeAt(_index);
            }
            finally {
    ...
    private class Rehash1 implements Runnable	{
    	...
    	Object[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, long[] oldK, Object[] oldV, byte[] oldS){
    ...
    public boolean adjustValue (long key, Object amount) {
        int index = index(key);
        if (index < 0) {
            return false;
        } 
    ...
    public Object adjustOrPutValue (long key, Object adjust_amount, Object put_amount) {
        int index = insertKey(key);
    ...
    class TLongObjectValueHashIterator extends THashPrimitiveIterator implements TObjectIterator {
         ...
         * @param hash the <tt>TPrimitiveHash</tt> we will be iterating over.
         */
        TLongObjectValueHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
    ...
    class TLongObjectHashIterator extends THashPrimitiveIterator implements TLongObjectIterator {
         ...
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TLongObjectHashMap</tt> we will be iterating over.
         */
        TLongObjectHashIterator (TLongObjectHashMap map) {
            super(map);
        }
