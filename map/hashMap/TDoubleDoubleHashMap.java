...
//import paralel.collection.TDoubleCollection;
//import paralel.collection.TObjectCollection;
//import paralel.iterator.TDoubleIterator;
//import paralel.spliterator.TDoubleSpliterator;
...
import PJC.hash.TDoubleDoubleHash;
import PJC.iterator.TDoubleIterator;
import PJC.list.ArraysPar;
import PJC.map.TDoubleDoubleMap;
import PJC.map.hashMap.HashFunctions;
import PJC.map.iterator.TDoubleDoubleIterator;
import PJC.set.TDoubleSet;
import PJC.spliterator.TDoubleSpliterator;

public class TDoubleDoubleHashMap extends TDoubleDoubleHash implements TDoubleDoubleMap, Serializable, Cloneable {
     ...
     */
    public TDoubleDoubleHashMap (double[] keys, double[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * @param numProcs number of processors that will be used
     */
    public TDoubleDoubleHashMap(TDoubleDoubleMap map, int numProcs) {
        super(map.size());
        if (map instanceof TDoubleDoubleHashMap) {
            TDoubleDoubleHashMap hashmap = (TDoubleDoubleHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TDoubleDoubleHashMap clone() {
        TDoubleDoubleHashMap result;
        try {
            result = (TDoubleDoubleHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TDoubleDoubleHashMap clonePar(int numProcs) {
        TDoubleDoubleHashMap result;
        try {
            result = (TDoubleDoubleHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
    ...
    public double compute (double key,
    	...
    	int index = index (key);
    	Double value = null;
    	if (index > 0)	value = remappingFunction.apply((Double)key, (Double)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public double comptueIfAbsent (double key, Function<? super Double,
    ...
    private class Equals1 implements Runnable	{
    	TDoubleDoubleMap that;
    	int min, max;
    	Equals1 (TDoubleDoubleMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TDoubleDoubleMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Double, ? super Double> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Double, ? super Double> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Double, ? super Double> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TDoubleDoubleHashMapSpliterator {
        final TDoubleDoubleHashMap map;
        ...
        TDoubleDoubleHashMapSpliterator(TDoubleDoubleHashMap m, int origin,
                           int fence, int est, double no_entry_key, double no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TDoubleDoubleKeySpliterator
        extends TDoubleDoubleHashMapSpliterator
        implements TDoubleSpliterator {
        TDoubleDoubleKeySpliterator(TDoubleDoubleHashMap m, int origin, int fence, int est, double no_entry, double no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TDoubleDoubleKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TDoubleDoubleKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TDoubleDoubleValueSpliterator
        extends TDoubleDoubleHashMapSpliterator
        implements TDoubleSpliterator {
        TDoubleDoubleValueSpliterator(TDoubleDoubleHashMap m, int origin, int fence, int est,
                         double no_entry_key, double no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TDoubleDoubleValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TDoubleDoubleValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TDoubleSet {
        ...
        public TDoubleSpliterator spliterator() {
        	return new TDoubleDoubleKeySpliterator(TDoubleDoubleHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public double[] toArrayPar (int numProcs) {
            return TDoubleDoubleHashMap.this.keysPar(numProcs);
        }
        ...
        public double[] toArrayPar (double[] dest, int numProcs)	{
        	return TDoubleDoubleHashMap.this.keysPar(dest, numProcs);
        }
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleDoubleHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TDoubleDoubleHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TDoubleDoubleHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TDoubleDoubleHashMap.this.index((Double)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TDoubleDoubleHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Double> action)	{
        	TDoubleDoubleHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Double> action, int numProcs)	{
        	TDoubleDoubleHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public double merge (double key, double value, BiFunction<? super Double, ? super Double,
    		? extends Double> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public double putPar (double key, double value) {
    ...
    private double doPut (double key, double value, int index) {
      ...
      * with key
      */
     public double putParAll (double key, double value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private double doPutAll(double key, double value, int index) {
        double previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    public void putAll (Map<? extends Double, ? extends Double> map) {
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Double, ? extends Double> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	double[] keys;
     	double[] values;
     	PutAll2 (int a, int b, double[] c, double[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TDoubleDoubleMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (double[] keys, double[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(double[] keys, double[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    public void replaceAll (BiFunction 
    			<? super Double, ? super Double, ? extends Double> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	...
    	ReplaceAll1 (int a, int b, BiFunction <? super Double, ? super Double,
			? extends Double> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Double, ? super Double,
    ...
    protected class TValueView implements TDoubleCollection {
        ...
        /** {@inheritDoc} */
        public TDoubleSpliterator spliterator() {
        	return new TDoubleDoubleValueSpliterator(TDoubleDoubleHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        /** {@inheritDoc} */
        public boolean containsPar(double entry, int numProcs) {
            return TDoubleDoubleHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public double[] toArray() {
            return TDoubleDoubleHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public double[] toArrayPar(int numProcs) {
            return TDoubleDoubleHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public double[] toArray(double[] dest) {
            return TDoubleDoubleHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public double[] toArrayPar(double[] dest, int numProcs) {
            return TDoubleDoubleHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	double[] values = TDoubleDoubleHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        /** {@inheritDoc} */
        public void forEach (Consumer<? super Double> action)	{
        	TDoubleDoubleHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Double> action, int numProcs)	{
        	TDoubleDoubleHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    private class Rehash1 implements Runnable	{
    	...
    	double[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, double[] oldK, double[] oldV, byte[] oldS){
