...
public class TLongDoubleHashMap extends TLongDoubleHash implements TLongDoubleMap, Serializable, Cloneable {
     ...
     */
    public TLongDoubleHashMap (long[] keys, double[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * @param numProcs number of processors that will be used
     */
    public TLongDoubleHashMap(TLongDoubleMap map, int numProcs) {
        super(map.size());
        if (map instanceof TLongDoubleHashMap) {
            TLongDoubleHashMap hashmap = (TLongDoubleHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TLongDoubleHashMap clone() {
        TLongDoubleHashMap result;
        try {
            result = (TLongDoubleHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TLongDoubleHashMap clonePar(int numProcs) {
        TLongDoubleHashMap result;
        try {
            result = (TLongDoubleHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
    ...
    public double compute (long key,
    	...
    	int index = index (key);
    	Double value = null;
    	if (index > 0)	value = remappingFunction.apply((Long)key, (Double)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public double comptueIfAbsent (long key, Function<? super Long,
    ...
    private class Equals1 implements Runnable	{
    	TLongDoubleMap that;
    	int min, max;
    	Equals1 (TLongDoubleMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TLongDoubleMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Long, ? super Double> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Long, ? super Double> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Long, ? super Double> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TLongDoubleHashMapSpliterator {
        final TLongDoubleHashMap map;
        ...
        TLongDoubleHashMapSpliterator(TLongDoubleHashMap m, int origin,
                           int fence, int est, long no_entry_key, double no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TLongDoubleKeySpliterator
        extends TLongDoubleHashMapSpliterator
        implements TLongSpliterator {
        TLongDoubleKeySpliterator(TLongDoubleHashMap m, int origin, int fence, int est, long no_entry, double no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TLongDoubleKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TLongDoubleKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TLongDoubleValueSpliterator
        extends TLongDoubleHashMapSpliterator
        implements TDoubleSpliterator {
        TLongDoubleValueSpliterator(TLongDoubleHashMap m, int origin, int fence, int est,
                         long no_entry_key, double no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TLongDoubleValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TLongDoubleValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TLongSet {
        ...
        public TLongSpliterator spliterator() {
        	return new TLongDoubleKeySpliterator(TLongDoubleHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public long[] toArrayPar (int numProcs) {
            return TLongDoubleHashMap.this.keysPar(numProcs);
        }
        ...
        public long[] toArrayPar (long[] dest, int numProcs)	{
        	return TLongDoubleHashMap.this.keysPar(dest, numProcs);
        }
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TLongDoubleHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TLongDoubleHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TLongDoubleHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TLongDoubleHashMap.this.index((Long)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TLongDoubleHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Long> action)	{
        	TLongDoubleHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Long> action, int numProcs)	{
        	TLongDoubleHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public double merge (long key, double value, BiFunction<? super Long, ? super Double,
    		? extends Double> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public double putPar (long key, double value) {
    ...
    private double doPut (long key, double value, int index) {
      ...
      * with key
      */
     public double putParAll (long key, double value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private double doPutAll(long key, double value, int index) {
        double previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    public void putAll (Map<? extends Long, ? extends Double> map) {
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Long, ? extends Double> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	long[] keys;
     	double[] values;
     	PutAll2 (int a, int b, long[] c, double[] d)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TLongDoubleMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (long[] keys, double[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(long[] keys, double[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    public void replaceAll (BiFunction 
    			<? super Long, ? super Double, ? extends Double> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	...
    	ReplaceAll1 (int a, int b, BiFunction <? super Long, ? super Double,
			? extends Double> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Long, ? super Double,
    ...
    protected class TValueView implements TDoubleCollection {
        ...
        public TDoubleSpliterator spliterator() {
        	return new TLongDoubleValueSpliterator(TLongDoubleHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean containsPar(double entry, int numProcs) {
            return TLongDoubleHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public double[] toArray() {
            return TLongDoubleHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public double[] toArrayPar(int numProcs) {
            return TLongDoubleHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public double[] toArray(double[] dest) {
            return TLongDoubleHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public double[] toArrayPar(double[] dest, int numProcs) {
            return TLongDoubleHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	double[] values = TLongDoubleHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public void forEach (Consumer<? super Double> action)	{
        	TLongDoubleHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Double> action, int numProcs)	{
        	TLongDoubleHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    private class Rehash1 implements Runnable	{
    	...
    	double[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, long[] oldK, double[] oldV, byte[] oldS){
