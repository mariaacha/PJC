...
public class TShortObjectHashMap extends TShortObjectHash implements TShortObjectMap, Serializable, Cloneable {
     ...
     */
    public TShortObjectHashMap (int initialCapacity, float loadFactor,
        short noEntryKey, Object noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }


    /**
     * Creates a new <code>TShortObjectHashMap</code> instance containing
     ...
     */
    public TShortObjectHashMap (short[] keys, Object[] values) {
     ...
     */
    public TShortObjectHashMap (short[] keys, Object[] values, int numProcs) {
        super(Math.max(keys.length, values.length));
     ...
     * all of the entries in the map passed in.
     *
     * @param map a <tt>TShortObjectMap</tt> that will be duplicated.
     */
    public TShortObjectHashMap (TShortObjectMap map) {
        super(map.size());
        if (map instanceof TShortObjectHashMap) {
            TShortObjectHashMap hashmap = (TShortObjectHashMap) map;
     ...
     * @param numProcs number of processors that will be used
     */
    public TShortObjectHashMap(TShortObjectMap map, int numProcs) {
        super(map.size());
        if (map instanceof TShortObjectHashMap) {
            TShortObjectHashMap hashmap = (TShortObjectHashMap) map;
            this._loadFactor = hashmap._loadFactor;
     ...
     */
    public TShortObjectHashMap clone() {
        TShortObjectHashMap result;
        try {
            result = (TShortObjectHashMap)super.clone();
     ...
     * @return a shallow copy of this map
     */
    public TShortObjectHashMap clonePar(int numProcs) {
        TShortObjectHashMap result;
        try {
            result = (TShortObjectHashMap)super.clone();
        } catch (CloneNotSupportedException e) {
     ...
     */
    public Object compute (short key,
    			BiFunction<? super Short, ? super Object, ? extends Object> remappingFunction)	{
    	int index = index (key);
    	Object value = null;
    	if (index > 0)	value = remappingFunction.apply((Short)key, (Object)_values[index]);
    	if (value != null)	{
    		put (key, value);
    		return value;
    	}
     ...
     */
    public Object comptueIfAbsent (short key, Function<? super Short,
     ...
     * @return the new value associated with the specified key, or null if none
     */
    public Object computeIfPresent (short key,
    				BiFunction<? super Short, ? super Object, ? extends Object> remappingFunction)	{
    ...
    private class Equals1 implements Runnable	{
    	TShortObjectMap that;
    	int min, max;
    	Equals1 (TShortObjectMap obj, int a, int b)	{
    ...
    public boolean equalsPar (Object other, int numProcs)	{
    	if (!((other instanceof TShortObjectMap)||(other instanceof Map<?,?>)))	{
    		return false;
    	}
		boolGlobal = true;
     ...
     */
    public void forEach(BiConsumer<? super Short, ? super Object> action) {
        //Node<K,V>[] tab;
        if (action == null)
            throw new NullPointerException();
    ...
    private class ForEachPar1 implements Runnable	{
    	int min, max;
    	BiConsumer<? super Short, ? super Object> action;
    	ForEachPar1 (int a, int b, BiConsumer<? super Short, ? super Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void forEachPar (BiConsumer<? super Short, ? super Object> action, int numProcs)	{
    	if (action == null)
    		throw new NullPointerException();
    	if (_size > 0 && _values != null) {
    ...
    static class TShortObjectHashMapSpliterator {
        final TShortObjectHashMap map;
        ...
        TShortObjectHashMapSpliterator(TShortObjectHashMap m, int origin,
                           int fence, int est, short no_entry_key, Object no_entry_value) {
            this.map = m;
            this.index = origin;
            this.fence = fence;
            this.est = est;
    ...
    static final class TShortObjectKeySpliterator
        extends TShortObjectHashMapSpliterator
        implements TShortSpliterator {
        TShortObjectKeySpliterator(TShortObjectHashMap m, int origin, int fence, int est, short no_entry, Object no_value) {
            super(m, origin, fence, est, no_entry, no_value);
        }

        public TShortObjectKeySpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentKey != _no_entry_key) ? null :
            	new TShortObjectKeySpliterator(map, lo, index = mid, est >>>= 1,
    ...
    static final class TShortObjectValueSpliterator
        extends TShortObjectHashMapSpliterator
        implements TObjectSpliterator {
        TShortObjectValueSpliterator(TShortObjectHashMap m, int origin, int fence, int est,
                         short no_entry_key, Object no_entry_value) {
            super(m, origin, fence, est, no_entry_key, no_entry_value);
        }

        public TShortObjectValueSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid || currentValue != _no_entry_value) ? null :
                new TShortObjectValueSpliterator(map, lo, index = mid, est >>>= 1,
                                          _no_entry_key, _no_entry_value);
        }
    ...
    protected class TKeyView implements TShortSet {
        ...
        public TShortIterator iterator() {
            return new TShortObjectKeyHashIterator (TShortObjectHashMap.this);
        }
        
        /** {@inheritDoc} */
        public TShortSpliterator spliterator() {
        	return new TShortObjectKeySpliterator(TShortObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (short entry) {
            return TShortObjectHashMap.this.contains(entry);
        }
        ...
        public short[] toArrayPar (int numProcs) {
            return TShortObjectHashMap.this.keysPar(numProcs);
        }
        ...
        public short[] toArrayPar (short[] dest, int numProcs)	{
        	return TShortObjectHashMap.this.keysPar(dest, numProcs);
        }


        /**
         * Unsupported when operating upon a Key Set view of a TShortObjectMap
         * <p/>
         * {@inheritDoc}
         */
        ...
        public boolean remove (short entry) {
            return no_entry_value != TShortObjectHashMap.this.remove(entry);
        }
        /** {@inheritDoc} */
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
                    ...
                    if (array[i] instanceof Short) {
                        ...
                        if (!TShortObjectHashMap.this.containsKey(ele)) {
                            boolGlobal = false;
                            return;
                        }
                    } 
        ...
        private class ContainsAll2 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TShortObjectHashMap.this.containsKey (array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        private class ContainsAll3 implements Runnable	{
        	...
        	public void run ()	{
        		for (int i=min; i<max; i++) {
        			if (!boolGlobal)	return;
                    if (!TShortObjectHashMap.this.contains(array[i])) {
                        boolGlobal = false;
                        return;
                    }
                }
        ...
        public boolean containsAll (short[] array) {
            for (short element : array) {
                if (!TShortObjectHashMap.this.contains(element)) {
                    return false;
                }
            }
            return true;
        ...
        private class RetainAll2 implements Runnable	{
        	...
        	public void run ()	{
        		...
        		for (int i=min; i<max; i++) {
        			//if (_states[i] == FULL)	{
        			int pos = TShortObjectHashMap.this.index(array[i]);
        			if (pos < 0)	{
        ...
        private class RemoveAll0 implements Runnable	{
        	...
        	public void run()	{
        		...
        		for (int i=min; i<max; i++)	{
        			if (_states[i] == FULL)	{
        				int pos = TShortObjectHashMap.this.index((Short)array[i]);
        				if (pos >= 0)	{
        					_states[i] = REMOVED;
        					removed++;
        				}
        ...
        public boolean removeAllPar2 (short[] array, int numProcs)	{
        	atIntGlobal = new AtomicInteger(0);
        	Arrays.sort(array);
        	int oldSize = _size;
        	int numElemProc = _set.length/numProcs;
        ...
        /** {@inheritDoc} */
        public void clearPar(int numProcs)	{
        	TShortObjectHashMap.this.clearPar(numProcs);
        }


        /** {@inheritDoc} */
        public void forEach (Consumer<? super Short> action)	{
        	TShortObjectHashMap.this.forEachKey (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Short> action, int numProcs)	{
        	TShortObjectHashMap.this.forEachKeyPar (action, numProcs);
        }
    ...
    /** {@inheritDoc} */
    public Object merge (short key, Object value, BiFunction<? super Short, ? super Object,
    		? extends Object> remappingFunction)	{
    	if (value == no_entry_value)
    		throw new NullPointerException();
    	if (remappingFunction == null)
     ...
     * with key
     */
     public Object putPar (short key, Object value) {
     ...
     */
    private Object doPut (short key, Object value, int index) {
      ...
      * with key
      */
     public Object putParAll (short key, Object value) {
     	//System.out.println ("Put: " + key + ", " + value);
     ...
     * associated null with key
     */
    private Object doPutAll(short key, Object value, int index) {
        Object previous = no_entry_value;
        //boolean isNewMapping = true;
        if (index < 0) {
    ...
    /** {@inheritDoc} */
    public void putAll (Map<? extends Short, ? extends Object> map) {
        ensureCapacity(map.size());
        // could optimize this for cases when map instanceof THashMap
        for (Map.Entry<? extends Short, ? extends Object> entry : map.entrySet()) {
            //this.put(entry.getKey().shortValue(), entry.getValue().ObjectValue());
        	this.put(entry.getKey().shortValue(), entry.getValue());
        }
    }
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(Map<? extends Short, ? extends Object> map, int numProcs) {
         ensureCapacity(map.size());
         atIntGlobal = new AtomicInteger(0);
     ...
     private class PutAll2 implements Runnable	{
     	...
     	short[] keys;
     	Object[] values;
     	PutAll2 (int a, int b, short[] c, Object[] d)	{
     ...
     /** {@inheritDoc} */
     public void putAll (TShortObjectMap map) {
         ensureCapacity(map.size());
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar (TShortObjectMap map, int numProcs) {
         ensureCapacity(map.size());
         int numMin, numMax;
         threads = new Thread[numProcs];
     ...
     /** {@inheritDoc} */
     public void putAll (short[] keys, Object[] values)	{
      ...
      * @param numProcs number of threads that will be used
      */
     public void putAllPar(short[] keys, Object[] values, int numProcs) {	
     	int size = keys.length;
         ensureCapacity (size);
         _size+=size;
         _free-=size;
    ...
    /** {@inheritDoc} */
    public Object putIfAbsent (short key, Object value) {
        int index = insertKey(key);
        if (index < 0)
    ...
    /** {@inheritDoc} */
    public Object replace (short key, Object value)	{
    	int index = index (key);
    	if (index > 0)	{
    ...
    /** {@inheritDoc} */
    public boolean replace (short key, Object oldValue, Object newValue)	{
    	int index = index (key);
    ...
    public void replaceAll (BiFunction 
    			<? super Short, ? super Object, ? extends Object> function)	{
    	for (int i=0; i<_values.length; i++)	{
    		if (_states[i] == FULL)	{
    ...
    private class ReplaceAll1 implements Runnable	{
    	int min, max;
    	BiFunction <? super Short, ? super Object, ? extends Object> function;
    	ReplaceAll1 (int a, int b, BiFunction <? super Short, ? super Object,
			? extends Object> c)	{
     ...
     * @param numProcs number of threads that will be used
     */
    public void replaceAllPar (BiFunction <? super Short, ? super Object,
    ...
    protected class TValueView implements TObjectCollection {
        ...
        public TObjectSpliterator spliterator() {
        	return new TShortObjectValueSpliterator(TShortObjectHashMap.this, 0, -1, 0, no_entry_key, no_entry_value);
        }
        ...
        public boolean contains (Object entry) {
            return TShortObjectHashMap.this.containsValue(entry);
        }
        @Override
        /** {@inheritDoc} */
        public boolean containsPar(Object entry, int numProcs) {
            return TShortObjectHashMap.this.containsValuePar(entry, numProcs);
        }


        /** {@inheritDoc} */
        public Object[] toArray() {
            return TShortObjectHashMap.this.toArrayValues();
        }

        /** {@inheritDoc} */
        public Object[] toArrayPar(int numProcs) {
            return TShortObjectHashMap.this.toArrayValuesPar(numProcs);
        }

        /** {@inheritDoc} */
        public Object[] toArray(Object[] dest) {
            return TShortObjectHashMap.this.toArrayValues(dest);
        }
        /** {@inheritDoc} */
        public Object[] toArrayPar(Object[] dest, int numProcs) {
            return TShortObjectHashMap.this.toArrayValuesPar(dest, numProcs);
        }
        ...
        public boolean containsAllPar (Collection<?> collection, int numProcs)	{
        	...
        	Object[] values = TShortObjectHashMap.this.values().toArrayPar(numProcs);
        	Arrays.sort(values);
        	int numMin, numMax;
            threads = new Thread[numProcs];
        	for (int i=0; i<numProcs; i++)	{
        ...
        public boolean containsAll(Collection<?> collection) {
            for (Object element : collection) {
                if (element instanceof Object) {
                    ...
                    if (!TShortObjectHashMap.this.containsValue(element)) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll (TObjectCollection collection) {
            ...
            while (iter.hasNext()) {
                if (!TShortObjectHashMap.this.containsValue(iter.next())) {
                    return false;
                }
            }
            return true;
        ...
        public void forEach (Consumer<? super Object> action)	{
        	TShortObjectHashMap.this.forEachValue (action);
        }
        /** {@inheritDoc} */
        public void forEachPar (Consumer<? super Object> action, int numProcs)	{
        	TShortObjectHashMap.this.forEachValuePar (action, numProcs);
        }
    ...
    class TShortObjectKeyHashIterator extends THashPrimitiveIterator implements TShortIterator {
         ...
         */
        TShortObjectKeyHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TShortObjectHashMap.this.removeAt(_index);
            }
            finally {
    ...
    private class Rehash1 implements Runnable	{
    	...
    	Object[] oldValues;
    	byte[] oldStates;
    	Rehash1 (int a, int b, short[] oldK, Object[] oldV, byte[] oldS){
    ...
    public boolean adjustValue (short key, Object amount) {
        int index = index(key);
        if (index < 0) {
            return false;
        } 
    ...
    public Object adjustOrPutValue (short key, Object adjust_amount, Object put_amount) {
        int index = insertKey(key);
    ...
    class TShortObjectValueHashIterator extends THashPrimitiveIterator implements TObjectIterator {
         ...
         * @param hash the <tt>TPrimitiveHash</tt> we will be iterating over.
         */
        TShortObjectValueHashIterator (TPrimitiveHash hash) {
            super(hash);
        }
    ...
    class TShortObjectHashIterator extends THashPrimitiveIterator implements TShortObjectIterator {
         ...
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TShortObjectHashMap</tt> we will be iterating over.
         */
        TShortObjectHashIterator (TShortObjectHashMap map) {
            super(map);
        }
