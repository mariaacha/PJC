...
public interface TLongByteMap {
     ...
     */
    public byte compute (long key, BiFunction<? super Long, ? super Byte,
     ...
     */
    public byte computeIfPresent (long key, BiFunction<? super Long, ? super Byte,
    		? extends Byte> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Long, ? extends Byte> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TLongByteMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Long, ? super Byte,
