...
public interface TObjectFloatMap {
     ...
     */
    public float compute (Object key, BiFunction<? super Object, ? super Float,
     ...
     */
    public float computeIfPresent (Object key, BiFunction<? super Object, ? super Float,
    		? extends Float> remappingFunction);
     ...
     */
    public void putAll (Map<? extends Object, ? extends Float> m);
    /**
     * Copies all of the mappings from the specified map to this map. The effect of this call
     * is equivalent to that of calling <code>put (k, v)</code> on this map once for each
     * mapping from key k to value v in the specified map. The behavior of this operation is
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Object, ? extends Float> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TObjectFloatMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Object, ? super Float,
    		? extends Float> function);
