...
public interface TFloatIntMap {
     ...
     */
    public int compute (float key, BiFunction<? super Float, ? super Integer,
     ...
     */
    public int computeIfPresent (float key, BiFunction<? super Float, ? super Integer,
    		? extends Integer> remappingFunction);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (Map<? extends Float, ? extends Integer> m, int numProcs);
     ...
     * @param numProcs number of threads that will be used
     */
    public void putAllPar (TFloatIntMap m, int numProcs);
     ...
     */
    public void replaceAll (BiFunction<? super Float, ? super Integer,
