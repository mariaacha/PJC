...
public interface TDoubleSpliterator {
    /**
     ...
     * else {@code false}
     */
    default boolean hasDoubleistics(int characteristics) {
    ...
    /**
     * Doubleistic value signifying that an encounter order is defined for
    ...
    /**
     * Doubleistic value signifying that, for each pair of
    ...
    /**
     * Doubleistic value signifying that encounter order follows a defined
    ...
    /**
     * Doubleistic value signifying that the value returned from
    ...
    /**
     * Doubleistic value signifying that the source guarantees that
    ...
    /**
     * Doubleistic value signifying that the element source cannot be
    ...
    /**
     * Doubleistic value signifying that the element source may be safely
    ...
    /**
     * Doubleistic value signifying that all Spliterators resulting from
