...
public interface TByteSpliterator {
    /**
     ...
     */
    boolean tryAdvance(Consumer<? super Byte> action);
     ...
     * type must be a wrapper type for a primitive type, such as {@code Byte}
     * for the primitive {@code int} type.
     * @param <T_CONS> the type of primitive consumer.  The type must be a
     * primitive specialization of {@link java.util.function.Consumer} for
     * {@code T}, such as {@link java.util.function.ByteConsumer} for
     * {@code Byte}.
     * @param <T_SPLITR> the type of primitive Spliterator.  The type must be
     * a primitive specialization of Spliterator for {@code T}, such as
     * {@link Spliterator.OfInt} for {@code Byte}.
