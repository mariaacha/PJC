...
public interface TLongSpliterator {
    /**
     ...
     * else {@code false}
     */
    default boolean hasLongistics(int characteristics) {
    ...
    /**
     * Longistic value signifying that an encounter order is defined for
    ...
    /**
     * Longistic value signifying that, for each pair of
    ...
    /**
     * Longistic value signifying that encounter order follows a defined
    ...
    /**
     * Longistic value signifying that the value returned from
    ...
    /**
     * Longistic value signifying that the source guarantees that
    ...
    /**
     * Longistic value signifying that the element source cannot be
    ...
    /**
     * Longistic value signifying that the element source may be safely
    ...
    /**
     * Longistic value signifying that all Spliterators resulting from
