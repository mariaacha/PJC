...
abstract public class TLongObjectHash extends TPrimitiveHash {
     ...
     */
    public TLongObjectHash( int initialCapacity ) {
     ...
     */
    public TLongObjectHash (int initialCapacity, float loadFactor) {
