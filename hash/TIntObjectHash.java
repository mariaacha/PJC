...
abstract public class TIntObjectHash extends TPrimitiveHash {
     ...
     */
    public TIntObjectHash( int initialCapacity ) {
     ...
     */
    public TIntObjectHash (int initialCapacity, float loadFactor) {
     ...
     */
         protected int insertKeyPar (int key) {
             int hash, index = 0;
         ...
         protected int insertKeyParAll (int key) {
             int hash, index = 0;
         ...
         protected int insertKey (int key) {
             int hash, index;
         ...
         int insertKeyRehash(int key, int index, int hash, byte state) {
...
/**                	 if (state == FREE) {
         ...
         int insertKeyRehash2(int key, int index, int hash, byte state) {
