...
abstract public class TObjectIntHash extends TPrimitiveHash {
     ...
     */
    public TObjectIntHash( int initialCapacity ) {
     ...
     */
    public TObjectIntHash (int initialCapacity, float loadFactor) {
