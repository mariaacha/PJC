...
abstract public class TObjectObjectHash extends TPrimitiveHash {
	static final Object serialVersionUID = 1L;
     ...
     */
    public TObjectObjectHash() {
        super();
        no_entry_key = (Object) 0;
        no_entry_value = (Object) 0;
    }
     ...
     */
    public TObjectObjectHash( int initialCapacity ) {
     ...
     */
    public TObjectObjectHash (int initialCapacity, float loadFactor) {
    ...
    int indexRehashed (Object key, int index, int hash, byte state) {
     ...
     */
         protected int insertKeyPar (Object key) {
             int hash, index = 0;
         ...
         protected int insertKeyParAll (Object key) {
             int hash, index = 0;
         ...
         int insertKeyRehash(Object key, int index, int hash, byte state) {
...
/**                	 if (state == FREE) {
         ...
         int insertKeyRehash2(Object key, int index, int hash, byte state) {
         ...
         void insertKeyAt(int index, Object key) {
             _set[index] = key;  // insert value
             _states[index] = FULL;
         }

    protected int XinsertKey (Object key ) {
