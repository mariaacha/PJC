...
abstract public class TDoubleObjectHash extends TPrimitiveHash {
     ...
     */
    public TDoubleObjectHash( int initialCapacity ) {
     ...
     */
    public TDoubleObjectHash (int initialCapacity, float loadFactor) {
