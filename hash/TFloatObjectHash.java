...
abstract public class TFloatObjectHash extends TPrimitiveHash {
     ...
     */
    public TFloatObjectHash( int initialCapacity ) {
     ...
     */
    public TFloatObjectHash (int initialCapacity, float loadFactor) {
     ...
     */
         protected int insertKeyPar (float key) {
             int hash, index = 0;
         ...
         protected int insertKeyParAll (float key) {
             int hash, index = 0;
         ...
         protected int insertKey (float key) {
             int hash, index;
         ...
         int insertKeyRehash(float key, int index, int hash, byte state) {
...
/**                	 if (state == FREE) {
         ...
         int insertKeyRehash2(float key, int index, int hash, byte state) {
