...
abstract public class TShortObjectHash extends TPrimitiveHash {
     ...
     */
    public TShortObjectHash( int initialCapacity ) {
     ...
     */
    public TShortObjectHash (int initialCapacity, float loadFactor) {
     ...
     */
         protected int insertKeyPar (short key) {
             int hash, index = 0;
         ...
         protected int insertKeyParAll (short key) {
             int hash, index = 0;
         ...
         protected int insertKey (short key) {
             int hash, index;
         ...
         int insertKeyRehash(short key, int index, int hash, byte state) {
...
/**                	 if (state == FREE) {
         ...
         int insertKeyRehash2(short key, int index, int hash, byte state) {
         ...
         void insertKeyAt(int index, short key) {
