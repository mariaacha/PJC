...
abstract public class TObjectShortHash extends TPrimitiveHash {
     ...
     */
    public TObjectShortHash( int initialCapacity ) {
     ...
     */
    public TObjectShortHash (int initialCapacity, float loadFactor) {
