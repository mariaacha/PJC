...
abstract public class TObjectFloatHash extends TPrimitiveHash {
     ...
     */
    public TObjectFloatHash( int initialCapacity ) {
     ...
     */
    public TObjectFloatHash (int initialCapacity, float loadFactor) {
