...
abstract public class TObjectLongHash extends TPrimitiveHash {
     ...
     */
    public TObjectLongHash( int initialCapacity ) {
     ...
     */
    public TObjectLongHash (int initialCapacity, float loadFactor) {
