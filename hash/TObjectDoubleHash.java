...
abstract public class TObjectDoubleHash extends TPrimitiveHash {
     ...
     */
    public TObjectDoubleHash( int initialCapacity ) {
     ...
     */
    public TObjectDoubleHash (int initialCapacity, float loadFactor) {
