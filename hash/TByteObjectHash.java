...
abstract public class TByteObjectHash extends TPrimitiveHash {
     ...
     */
    public TByteObjectHash( int initialCapacity ) {
     ...
     */
    public TByteObjectHash (int initialCapacity, float loadFactor) {
     ...
     */
         protected int insertKeyPar (byte key) {
             int hash, index = 0;
         ...
         protected int insertKeyParAll (byte key) {
             int hash, index = 0;
         ...
         protected int insertKey (byte key) {
             int hash, index;
         ...
         int insertKeyRehash(byte key, int index, int hash, byte state) {
...
/**                	 if (state == FREE) {
         ...
         int insertKeyRehash2(byte key, int index, int hash, byte state) {
         ...
         void insertKeyAt(int index, byte key) {
