...
abstract public class TCharObjectHash extends TPrimitiveHash {
     ...
     */
    public TCharObjectHash( int initialCapacity ) {
     ...
     */
    public TCharObjectHash (int initialCapacity, float loadFactor) {
     ...
     */
         protected int insertKeyPar (char key) {
             int hash, index = 0;
         ...
         protected int insertKeyParAll (char key) {
             int hash, index = 0;
         ...
         protected int insertKey (char key) {
             int hash, index;
         ...
         int insertKeyRehash(char key, int index, int hash, byte state) {
...
/**                	 if (state == FREE) {
         ...
         int insertKeyRehash2(char key, int index, int hash, byte state) {
         ...
         void insertKeyAt(int index, char key) {
