...
abstract public class TObjectCharHash extends TPrimitiveHash {
     ...
     */
    public TObjectCharHash( int initialCapacity ) {
     ...
     */
    public TObjectCharHash (int initialCapacity, float loadFactor) {
