...
abstract public class TObjectByteHash extends TPrimitiveHash {
     ...
     */
    public TObjectByteHash( int initialCapacity ) {
     ...
     */
    public TObjectByteHash (int initialCapacity, float loadFactor) {
