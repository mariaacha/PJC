...
public interface TIntSet extends TIntCollection {
    ...
    */
     ...
     * @param array array of ints containing elements to be added to this set
     * @return true if this set changed as a result of the call
    */
    ...
    */
     ...
     * @param array array of ints to be checked for containment in this set
    ...
    */
    ...
    /**
     * Compares the specified object with this set for equality. Returns true if the specified element is a <code>Set</code> or a <code>TIntSet</code>, the two sets have the same size, and every member of the specified set is contained in this set (or equivalently, every member of this set is contained in the specified set). This definition ensures that the equals method works properly across different implementations of the <code>Set</code> and <code>TIntSet</code> interfaces.
    ...
    */
     ...
     * @param array array of ints containing elements to be removed from this set
     * @return true if this set changed as a result of the call
    */
    ...
    */
     ...
     * @param array array of ints containing elements to be retained in this set
     * @return true if this set changed as a result of the call
    */
    ...
    */
    ...
    /**
     * Creates a TIntSpliterator over the elements in this set. The <code>TIntSpliterator</code> reports <code>TIntSpliterator.DISTINCT</code>. Implementations should document the reporting of additional characteristic values.
     * @return a <code>TIntSpliterator</code> over the elements in this set
    */
