...
public interface TShortSet extends TShortCollection {
    ...
    */
     ...
     * @return true if this set changed as a result of the call
    */
    boolean addAllPar (Collection<? extends Short> c, int numProcs);
     ...
     * @return true if this set changed as a result of the call
    */
    boolean addAll (TShortCollection c);
    /**
     * Adds all of the elements in the specified collection to this set if they're not already present. If the specified collection is also a set, the addAll operation effectively modifies this set so that its value is the union of the two sets. The behavior of this operation is undefined if the specified collection is modified while the operation is in progress.
     * @param c collection containing elements to be added to this set
     * @param numProcs number of threads that will be used
     * @return true if this set changed as a result of the call
    */
    boolean addAllPar (TShortCollection c, int numProcs);
     ...
     * @param array array of shorts containing elements to be added to this set
     * @return true if this set changed as a result of the call
    */
     ...
     * @return true if this set changed as a result of the call
    */
    boolean addAllPar (short[] array, int numProcs);
    ...
    */
     ...
     * @return true if this set contains the specified element
    */
    boolean containsPar (short o, int numProcs);
    ...
    */
     ...
     * @return true if this set contains all of the elements of the specified collection
    */
    boolean containsAll (TShortCollection c);
    /**
     * Returns true if this set contains all of the elements of the specified collection. If the specified collection is also a set, this method returns true if it is a subset of this set.
     * @param c collection to be checked for containment in this set
     * @param numProcs number of threads that will be used
     * @return true if this set contains all of the elements of the specified collection
    */
    boolean containsAllPar (TShortCollection c, int numProcs);

	/**
     * Returns true if this set contains all of the elements of the specified array.
     * @param array array of shorts to be checked for containment in this set
    ...
    */
     ...
     * @return true if this set contains all of the elements of the specified array
    */
    boolean containsAllPar (short[] array, int numProcs);


    /**
     * Compares the specified object with this set for equality. Returns true if the specified element is a <code>Set</code> or a <code>TShortSet</code>, the two sets have the same size, and every member of the specified set is contained in this set (or equivalently, every member of this set is contained in the specified set). This definition ensures that the equals method works properly across different implementations of the <code>Set</code> and <code>TShortSet</code> interfaces.
    ...
    */
     ...
     * @return true if this set contained the specified element
    */
    boolean removePar (short o, int numProcs);
    ...
    */
     ...
     * @return true if this set changed as a result of the call
    */
    boolean removeAll (TShortCollection c);
    /**
     * Removes from this set all of its elements that are contained in the specified collection. If the specified collection is also a set, this operation effectively modifies this set so that its value is the asymmetric set difference of the two sets.
     * @param c collection containing elements to be removed from this set
     * @param numProcs number of threads that will be used
     * @return true if this set changed as a result of the call
    */
    boolean removeAllPar (TShortCollection c, int numProcs);

	/**
     * Removes from this set all of its elements that are contained in the specified array.
     * @param array array of shorts containing elements to be removed from this set
     * @return true if this set changed as a result of the call
    */
    ...
    */
     ...
     * @return true if this set changed as a result of the call
    */
    boolean retainAll (TShortCollection c);
    /**
     * Retains only the elements in this set that are contained in the specified collection. In other words, removes from this set all of its elements that are not contained in the specified collection. If the specified collection is also a set, this operation effectively modifies this set so that its value is the intersection of the two sets.
     * @param c collection containing elements to be retained in this set
     * @param numProcs number of threads that will be used
     * @return true if this set changed as a result of the call
    */
    boolean retainAllPar (TShortCollection c, int numProcs);
     ...
     * @param array array of shorts containing elements to be retained in this set
     * @return true if this set changed as a result of the call
    */
     ...
     * @return true if this set changed as a result of the call
    */
    boolean retainAllPar (short[] array, int numProcs);
    ...
    */
    ...
    /**
     * Creates a TShortSpliterator over the elements in this set. The <code>TShortSpliterator</code> reports <code>TShortSpliterator.DISTINCT</code>. Implementations should document the reporting of additional characteristic values.
     * @return a <code>TShortSpliterator</code> over the elements in this set
    */
    TShortSpliterator spliterator();
    ...
    */
     ...
     * @return an array containing the elements in this set
     */
    short[] toArrayPar (short[] a, int numProcs);
